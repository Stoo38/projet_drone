...
-- servo	=>  Location: PIN_AA21,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL \servo~input_o\ : std_logic;
...
SIGNAL \send_ppm1|local_counter1|o_count[4]~feeder_combout\ : std_logic;
...
SIGNAL \send_ppm1|local_counter1|ALT_INV_Add0~73_sumout\ : std_logic;
...
\send_ppm1|Mult0~8_AX_bus\ <= (\i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\);
...
\send_ppm1|Mult2~8_AX_bus\ <= (\i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\ & \i_sel_top[2]~input_o\);
...
\send_ppm1|Mult1~8_AX_bus\ <= (\i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\ & \i_sel_top[1]~input_o\);
...
\send_ppm1|Mult3~8_AX_bus\ <= (\i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\ & \i_sel_top[3]~input_o\);
...
\send_ppm1|local_counter1|ALT_INV_Add0~73_sumout\ <= NOT \send_ppm1|local_counter1|Add0~73_sumout\;
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Mult2~9\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~25_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~1_sumout\ = SUM(( !\send_ppm1|Add5~25_sumout\ $ (!\send_ppm1|Add1~25_sumout\ $ (\send_ppm1|Add3~25_sumout\)) ) + ( !VCC ) + ( !VCC ))
-- \send_ppm1|Add8~2\ = CARRY(( !\send_ppm1|Add5~25_sumout\ $ (!\send_ppm1|Add1~25_sumout\ $ (\send_ppm1|Add3~25_sumout\)) ) + ( !VCC ) + ( !VCC ))
-- \send_ppm1|Add8~3\ = SHARE((!\send_ppm1|Add5~25_sumout\ & (\send_ppm1|Add1~25_sumout\ & \send_ppm1|Add3~25_sumout\)) # (\send_ppm1|Add5~25_sumout\ & ((\send_ppm1|Add3~25_sumout\) # (\send_ppm1|Add1~25_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~25_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~25_sumout\,
	datad => \send_ppm1|ALT_INV_Add3~25_sumout\,
	cin => GND,
	sharein => GND,
...
-- Equation(s):
-- \send_ppm1|Add8~5_sumout\ = SUM(( !\send_ppm1|Add5~29_sumout\ $ (!\send_ppm1|Add3~29_sumout\ $ (\send_ppm1|Add1~29_sumout\)) ) + ( \send_ppm1|Add8~3\ ) + ( \send_ppm1|Add8~2\ ))
-- \send_ppm1|Add8~6\ = CARRY(( !\send_ppm1|Add5~29_sumout\ $ (!\send_ppm1|Add3~29_sumout\ $ (\send_ppm1|Add1~29_sumout\)) ) + ( \send_ppm1|Add8~3\ ) + ( \send_ppm1|Add8~2\ ))
-- \send_ppm1|Add8~7\ = SHARE((!\send_ppm1|Add5~29_sumout\ & (\send_ppm1|Add3~29_sumout\ & \send_ppm1|Add1~29_sumout\)) # (\send_ppm1|Add5~29_sumout\ & ((\send_ppm1|Add1~29_sumout\) # (\send_ppm1|Add3~29_sumout\))))
...
-- Equation(s):
-- \send_ppm1|Add8~37_sumout\ = SUM(( !\send_ppm1|Add1~33_sumout\ $ (!\send_ppm1|Add5~33_sumout\ $ (\send_ppm1|Add3~33_sumout\)) ) + ( \send_ppm1|Add8~7\ ) + ( \send_ppm1|Add8~6\ ))
-- \send_ppm1|Add8~38\ = CARRY(( !\send_ppm1|Add1~33_sumout\ $ (!\send_ppm1|Add5~33_sumout\ $ (\send_ppm1|Add3~33_sumout\)) ) + ( \send_ppm1|Add8~7\ ) + ( \send_ppm1|Add8~6\ ))
-- \send_ppm1|Add8~39\ = SHARE((!\send_ppm1|Add1~33_sumout\ & (\send_ppm1|Add5~33_sumout\ & \send_ppm1|Add3~33_sumout\)) # (\send_ppm1|Add1~33_sumout\ & ((\send_ppm1|Add3~33_sumout\) # (\send_ppm1|Add5~33_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add1~33_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~29_sumout\ = SUM(( !\send_ppm1|Add5~37_sumout\ $ (!\send_ppm1|Add3~37_sumout\ $ (\send_ppm1|Add1~37_sumout\)) ) + ( \send_ppm1|Add8~39\ ) + ( \send_ppm1|Add8~38\ ))
-- \send_ppm1|Add8~30\ = CARRY(( !\send_ppm1|Add5~37_sumout\ $ (!\send_ppm1|Add3~37_sumout\ $ (\send_ppm1|Add1~37_sumout\)) ) + ( \send_ppm1|Add8~39\ ) + ( \send_ppm1|Add8~38\ ))
-- \send_ppm1|Add8~31\ = SHARE((!\send_ppm1|Add5~37_sumout\ & (\send_ppm1|Add3~37_sumout\ & \send_ppm1|Add1~37_sumout\)) # (\send_ppm1|Add5~37_sumout\ & ((\send_ppm1|Add1~37_sumout\) # (\send_ppm1|Add3~37_sumout\))))
...
-- Equation(s):
-- \send_ppm1|Add10~1_sumout\ = SUM(( \send_ppm1|Add7~37_sumout\ ) + ( \send_ppm1|Add8~1_sumout\ ) + ( !VCC ))
-- \send_ppm1|Add10~2\ = CARRY(( \send_ppm1|Add7~37_sumout\ ) + ( \send_ppm1|Add8~1_sumout\ ) + ( !VCC ))
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add7~37_sumout\,
	cin => GND,
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add8~5_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~2_combout\ = ( \send_ppm1|Add12~29_sumout\ & ( \send_ppm1|Add12~37_sumout\ & ( (\send_ppm1|local_counter1|o_count\(2) & (\send_ppm1|local_counter1|o_count\(0) & (!\send_ppm1|Add12~33_sumout\ $ (\send_ppm1|local_counter1|o_count\(1))))) ) 
-- ) ) # ( !\send_ppm1|Add12~29_sumout\ & ( \send_ppm1|Add12~37_sumout\ & ( (\send_ppm1|local_counter1|o_count\(2) & (!\send_ppm1|local_counter1|o_count\(0) & (!\send_ppm1|Add12~33_sumout\ $ (\send_ppm1|local_counter1|o_count\(1))))) ) ) ) # ( 
-- \send_ppm1|Add12~29_sumout\ & ( !\send_ppm1|Add12~37_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(2) & (\send_ppm1|local_counter1|o_count\(0) & (!\send_ppm1|Add12~33_sumout\ $ (\send_ppm1|local_counter1|o_count\(1))))) ) ) ) # ( 
-- !\send_ppm1|Add12~29_sumout\ & ( !\send_ppm1|Add12~37_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(2) & (!\send_ppm1|local_counter1|o_count\(0) & (!\send_ppm1|Add12~33_sumout\ $ (\send_ppm1|local_counter1|o_count\(1))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(2),
	datab => \send_ppm1|ALT_INV_Add12~33_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(1),
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~17\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult2~19\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add4~53_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~37_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add4~41_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult1~16\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add2~41_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult0~18\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult0~19\,
...
-- Equation(s):
-- \send_ppm1|Add8~61_sumout\ = SUM(( !\send_ppm1|Add5~57_sumout\ $ (!\send_ppm1|Add3~57_sumout\ $ (\send_ppm1|Add1~61_sumout\)) ) + ( \send_ppm1|Add8~31\ ) + ( \send_ppm1|Add8~30\ ))
-- \send_ppm1|Add8~62\ = CARRY(( !\send_ppm1|Add5~57_sumout\ $ (!\send_ppm1|Add3~57_sumout\ $ (\send_ppm1|Add1~61_sumout\)) ) + ( \send_ppm1|Add8~31\ ) + ( \send_ppm1|Add8~30\ ))
-- \send_ppm1|Add8~63\ = SHARE((!\send_ppm1|Add5~57_sumout\ & (\send_ppm1|Add3~57_sumout\ & \send_ppm1|Add1~61_sumout\)) # (\send_ppm1|Add5~57_sumout\ & ((\send_ppm1|Add1~61_sumout\) # (\send_ppm1|Add3~57_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~57_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~57_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~61_sumout\,
...
-- Location: LABCELL_X33_Y30_N45
\send_ppm1|Add8~65\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|Add8~65_sumout\ = SUM(( !\send_ppm1|Add1~65_sumout\ $ (!\send_ppm1|Add3~61_sumout\ $ (\send_ppm1|Add5~61_sumout\)) ) + ( \send_ppm1|Add8~63\ ) + ( \send_ppm1|Add8~62\ ))
-- \send_ppm1|Add8~66\ = CARRY(( !\send_ppm1|Add1~65_sumout\ $ (!\send_ppm1|Add3~61_sumout\ $ (\send_ppm1|Add5~61_sumout\)) ) + ( \send_ppm1|Add8~63\ ) + ( \send_ppm1|Add8~62\ ))
-- \send_ppm1|Add8~67\ = SHARE((!\send_ppm1|Add1~65_sumout\ & (\send_ppm1|Add3~61_sumout\ & \send_ppm1|Add5~61_sumout\)) # (\send_ppm1|Add1~65_sumout\ & ((\send_ppm1|Add5~61_sumout\) # (\send_ppm1|Add3~61_sumout\))))
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add5~61_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~69_sumout\ = SUM(( !\send_ppm1|Add5~65_sumout\ $ (!\send_ppm1|Add3~65_sumout\ $ (\send_ppm1|Add1~53_sumout\)) ) + ( \send_ppm1|Add8~67\ ) + ( \send_ppm1|Add8~66\ ))
-- \send_ppm1|Add8~70\ = CARRY(( !\send_ppm1|Add5~65_sumout\ $ (!\send_ppm1|Add3~65_sumout\ $ (\send_ppm1|Add1~53_sumout\)) ) + ( \send_ppm1|Add8~67\ ) + ( \send_ppm1|Add8~66\ ))
-- \send_ppm1|Add8~71\ = SHARE((!\send_ppm1|Add5~65_sumout\ & (\send_ppm1|Add3~65_sumout\ & \send_ppm1|Add1~53_sumout\)) # (\send_ppm1|Add5~65_sumout\ & ((\send_ppm1|Add1~53_sumout\) # (\send_ppm1|Add3~65_sumout\))))
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Add3~65_sumout\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add5~49_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~45_sumout\ = SUM(( !\send_ppm1|Add5~53_sumout\ $ (!\send_ppm1|Add3~53_sumout\ $ (\send_ppm1|Add1~45_sumout\)) ) + ( \send_ppm1|Add8~43\ ) + ( \send_ppm1|Add8~42\ ))
-- \send_ppm1|Add8~46\ = CARRY(( !\send_ppm1|Add5~53_sumout\ $ (!\send_ppm1|Add3~53_sumout\ $ (\send_ppm1|Add1~45_sumout\)) ) + ( \send_ppm1|Add8~43\ ) + ( \send_ppm1|Add8~42\ ))
-- \send_ppm1|Add8~47\ = SHARE((!\send_ppm1|Add5~53_sumout\ & (\send_ppm1|Add3~53_sumout\ & \send_ppm1|Add1~45_sumout\)) # (\send_ppm1|Add5~53_sumout\ & ((\send_ppm1|Add1~45_sumout\) # (\send_ppm1|Add3~53_sumout\))))
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Add3~53_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~49_sumout\ = SUM(( !\send_ppm1|Add5~41_sumout\ $ (!\send_ppm1|Add3~41_sumout\ $ (\send_ppm1|Add1~49_sumout\)) ) + ( \send_ppm1|Add8~47\ ) + ( \send_ppm1|Add8~46\ ))
-- \send_ppm1|Add8~50\ = CARRY(( !\send_ppm1|Add5~41_sumout\ $ (!\send_ppm1|Add3~41_sumout\ $ (\send_ppm1|Add1~49_sumout\)) ) + ( \send_ppm1|Add8~47\ ) + ( \send_ppm1|Add8~46\ ))
-- \send_ppm1|Add8~51\ = SHARE((!\send_ppm1|Add5~41_sumout\ & (\send_ppm1|Add3~41_sumout\ & \send_ppm1|Add1~49_sumout\)) # (\send_ppm1|Add5~41_sumout\ & ((\send_ppm1|Add1~49_sumout\) # (\send_ppm1|Add3~41_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~41_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~41_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~17_sumout\ = SUM(( !\send_ppm1|Add1~13_sumout\ $ (!\send_ppm1|Add3~13_sumout\ $ (\send_ppm1|Add5~13_sumout\)) ) + ( \send_ppm1|Add8~51\ ) + ( \send_ppm1|Add8~50\ ))
-- \send_ppm1|Add8~18\ = CARRY(( !\send_ppm1|Add1~13_sumout\ $ (!\send_ppm1|Add3~13_sumout\ $ (\send_ppm1|Add5~13_sumout\)) ) + ( \send_ppm1|Add8~51\ ) + ( \send_ppm1|Add8~50\ ))
-- \send_ppm1|Add8~19\ = SHARE((!\send_ppm1|Add1~13_sumout\ & (\send_ppm1|Add3~13_sumout\ & \send_ppm1|Add5~13_sumout\)) # (\send_ppm1|Add1~13_sumout\ & ((\send_ppm1|Add5~13_sumout\) # (\send_ppm1|Add3~13_sumout\))))
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Add3~13_sumout\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add5~17_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~33_sumout\ = SUM(( !\send_ppm1|Add5~1_sumout\ $ (!\send_ppm1|Add3~1_sumout\ $ (\send_ppm1|Add1~5_sumout\)) ) + ( \send_ppm1|Add8~23\ ) + ( \send_ppm1|Add8~22\ ))
-- \send_ppm1|Add8~34\ = CARRY(( !\send_ppm1|Add5~1_sumout\ $ (!\send_ppm1|Add3~1_sumout\ $ (\send_ppm1|Add1~5_sumout\)) ) + ( \send_ppm1|Add8~23\ ) + ( \send_ppm1|Add8~22\ ))
-- \send_ppm1|Add8~35\ = SHARE((!\send_ppm1|Add5~1_sumout\ & (\send_ppm1|Add3~1_sumout\ & \send_ppm1|Add1~5_sumout\)) # (\send_ppm1|Add5~1_sumout\ & ((\send_ppm1|Add1~5_sumout\) # (\send_ppm1|Add3~1_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add5~1_sumout\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add8~69_sumout\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000101000000000101000000000000000000101000000000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult1~21\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult2~21\,
...
-- Equation(s):
-- \send_ppm1|Add8~9_sumout\ = SUM(( !\send_ppm1|Add3~5_sumout\ $ (!\send_ppm1|Add5~5_sumout\ $ (\send_ppm1|Add1~9_sumout\)) ) + ( \send_ppm1|Add8~35\ ) + ( \send_ppm1|Add8~34\ ))
-- \send_ppm1|Add8~10\ = CARRY(( !\send_ppm1|Add3~5_sumout\ $ (!\send_ppm1|Add5~5_sumout\ $ (\send_ppm1|Add1~9_sumout\)) ) + ( \send_ppm1|Add8~35\ ) + ( \send_ppm1|Add8~34\ ))
-- \send_ppm1|Add8~11\ = SHARE((!\send_ppm1|Add3~5_sumout\ & (\send_ppm1|Add5~5_sumout\ & \send_ppm1|Add1~9_sumout\)) # (\send_ppm1|Add3~5_sumout\ & ((\send_ppm1|Add1~9_sumout\) # (\send_ppm1|Add5~5_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~5_sumout\,
	datac => \send_ppm1|ALT_INV_Add5~5_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~9_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~9_sumout\ = SUM(( \send_ppm1|Add8~9_sumout\ ) + ( \send_ppm1|Add7~1_sumout\ ) + ( \send_ppm1|Add10~34\ ))
-- \send_ppm1|Add10~10\ = CARRY(( \send_ppm1|Add8~9_sumout\ ) + ( \send_ppm1|Add7~1_sumout\ ) + ( \send_ppm1|Add10~34\ ))
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add8~9_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~4_combout\ = ( \send_ppm1|Add12~49_sumout\ & ( \send_ppm1|Add12~45_sumout\ & ( (\send_ppm1|local_counter1|o_count\(9) & (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add12~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) ) 
-- ) ) # ( !\send_ppm1|Add12~49_sumout\ & ( \send_ppm1|Add12~45_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(9) & (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add12~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) ) ) ) # ( 
-- \send_ppm1|Add12~49_sumout\ & ( !\send_ppm1|Add12~45_sumout\ & ( (\send_ppm1|local_counter1|o_count\(9) & (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add12~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) ) ) ) # ( 
-- !\send_ppm1|Add12~49_sumout\ & ( !\send_ppm1|Add12~45_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(9) & (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add12~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(8),
	datac => \send_ppm1|ALT_INV_Add12~41_sumout\,
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(7),
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~22\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~17_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~25_sumout\ = SUM(( !\send_ppm1|Add3~21_sumout\ $ (!\send_ppm1|Add5~21_sumout\ $ (\send_ppm1|Add1~21_sumout\)) ) + ( \send_ppm1|Add8~11\ ) + ( \send_ppm1|Add8~10\ ))
-- \send_ppm1|Add8~26\ = CARRY(( !\send_ppm1|Add3~21_sumout\ $ (!\send_ppm1|Add5~21_sumout\ $ (\send_ppm1|Add1~21_sumout\)) ) + ( \send_ppm1|Add8~11\ ) + ( \send_ppm1|Add8~10\ ))
-- \send_ppm1|Add8~27\ = SHARE((!\send_ppm1|Add3~21_sumout\ & (\send_ppm1|Add5~21_sumout\ & \send_ppm1|Add1~21_sumout\)) # (\send_ppm1|Add3~21_sumout\ & ((\send_ppm1|Add1~21_sumout\) # (\send_ppm1|Add5~21_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~21_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~53_sumout\ = SUM(( !\send_ppm1|Add5~45_sumout\ $ (!\send_ppm1|Add1~57_sumout\ $ (\send_ppm1|Add3~45_sumout\)) ) + ( \send_ppm1|Add8~27\ ) + ( \send_ppm1|Add8~26\ ))
-- \send_ppm1|Add8~54\ = CARRY(( !\send_ppm1|Add5~45_sumout\ $ (!\send_ppm1|Add1~57_sumout\ $ (\send_ppm1|Add3~45_sumout\)) ) + ( \send_ppm1|Add8~27\ ) + ( \send_ppm1|Add8~26\ ))
-- \send_ppm1|Add8~55\ = SHARE((!\send_ppm1|Add5~45_sumout\ & (\send_ppm1|Add1~57_sumout\ & \send_ppm1|Add3~45_sumout\)) # (\send_ppm1|Add5~45_sumout\ & ((\send_ppm1|Add3~45_sumout\) # (\send_ppm1|Add1~57_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add5~45_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~57_sumout\ = SUM(( !\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~55\ ) + ( \send_ppm1|Add8~54\ ))
-- \send_ppm1|Add8~58\ = CARRY(( !\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~55\ ) + ( \send_ppm1|Add8~54\ ))
-- \send_ppm1|Add8~59\ = SHARE((!\send_ppm1|Add5~9_sumout\ & ((!\send_ppm1|Add1~1_sumout\) # (!\send_ppm1|Add3~9_sumout\))) # (\send_ppm1|Add5~9_sumout\ & (!\send_ppm1|Add1~1_sumout\ & !\send_ppm1|Add3~9_sumout\)))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add5~9_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~1_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~73_sumout\ = SUM(( !\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~59\ ) + ( \send_ppm1|Add8~58\ ))
-- \send_ppm1|Add8~74\ = CARRY(( !\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~59\ ) + ( \send_ppm1|Add8~58\ ))
-- \send_ppm1|Add8~75\ = SHARE((!\send_ppm1|Add1~1_sumout\ & ((!\send_ppm1|Add5~9_sumout\) # (!\send_ppm1|Add3~9_sumout\))) # (\send_ppm1|Add1~1_sumout\ & (!\send_ppm1|Add5~9_sumout\ & !\send_ppm1|Add3~9_sumout\)))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add7~17_sumout\,
	datac => \send_ppm1|ALT_INV_Add8~25_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add7~65_sumout\,
	datad => \send_ppm1|ALT_INV_Add8~53_sumout\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add8~57_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~73_sumout\ = SUM(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~73_sumout\ ) + ( \send_ppm1|Add10~58\ ))
-- \send_ppm1|Add10~74\ = CARRY(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~73_sumout\ ) + ( \send_ppm1|Add10~58\ ))
...
-- Equation(s):
-- \send_ppm1|Add10~77_sumout\ = SUM(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~13_sumout\ ) + ( \send_ppm1|Add10~74\ ))
-- \send_ppm1|Add10~78\ = CARRY(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~13_sumout\ ) + ( \send_ppm1|Add10~74\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add8~13_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~5_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~13_sumout\ = SUM(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~13_sumout\ ) + ( \send_ppm1|Add10~78\ ))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add8~13_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~5_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~1_combout\ = ( \send_ppm1|Add12~17_sumout\ & ( \send_ppm1|Add12~9_sumout\ & ( (\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add12~13_sumout\)))) 
-- ) ) ) # ( !\send_ppm1|Add12~17_sumout\ & ( \send_ppm1|Add12~9_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add12~13_sumout\)))) ) ) ) # ( 
-- \send_ppm1|Add12~17_sumout\ & ( !\send_ppm1|Add12~9_sumout\ & ( (\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add12~13_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|Add12~17_sumout\ & ( !\send_ppm1|Add12~9_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add12~13_sumout\)))) ) ) )
...
-- Equation(s):
-- \send_ppm1|Equal9~7_combout\ = ( \send_ppm1|Add12~53_sumout\ & ( \send_ppm1|Add12~57_sumout\ & ( (\send_ppm1|local_counter1|o_count\(16) & (\send_ppm1|local_counter1|o_count\(15) & \send_ppm1|Equal9~6_combout\)) ) ) ) # ( !\send_ppm1|Add12~53_sumout\ & ( 
-- \send_ppm1|Add12~57_sumout\ & ( (\send_ppm1|local_counter1|o_count\(16) & (!\send_ppm1|local_counter1|o_count\(15) & \send_ppm1|Equal9~6_combout\)) ) ) ) # ( \send_ppm1|Add12~53_sumout\ & ( !\send_ppm1|Add12~57_sumout\ & ( 
-- (!\send_ppm1|local_counter1|o_count\(16) & (\send_ppm1|local_counter1|o_count\(15) & \send_ppm1|Equal9~6_combout\)) ) ) ) # ( !\send_ppm1|Add12~53_sumout\ & ( !\send_ppm1|Add12~57_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(16) & 
-- (!\send_ppm1|local_counter1|o_count\(15) & \send_ppm1|Equal9~6_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000010100000000000000000101000000000010100000000000000000101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(16),
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(15),
	datad => \send_ppm1|ALT_INV_Equal9~6_combout\,
	datae => \send_ppm1|ALT_INV_Add12~53_sumout\,
	dataf => \send_ppm1|ALT_INV_Add12~57_sumout\,
	combout => \send_ppm1|Equal9~7_combout\);

-- Location: LABCELL_X36_Y31_N21
\send_ppm1|current_state~9\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|current_state~9_combout\ = ( \send_ppm1|Equal9~7_combout\ & ( (\send_ppm1|current_state.synchro~q\ & (\i_reset_n_top~input_o\ & (\send_ppm1|Equal9~5_combout\ & \send_ppm1|Equal9~8_combout\))) ) )
...
PORT MAP (
	...
	dataf => \send_ppm1|ALT_INV_Equal9~7_combout\,
	combout => \send_ppm1|current_state~9_combout\);

-- Location: FF_X36_Y31_N22
...
-- Equation(s):
-- \send_ppm1|Add8~13_sumout\ = SUM(( !\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~75\ ) + ( \send_ppm1|Add8~74\ ))
...
-- Equation(s):
-- \send_ppm1|Equal9~8_combout\ = ( \send_ppm1|Add12~73_sumout\ & ( (\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|Add12~77_sumout\ $ (\send_ppm1|local_counter1|o_count\(18)))) ) ) # ( !\send_ppm1|Add12~73_sumout\ & ( 
-- (!\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|Add12~77_sumout\ $ (\send_ppm1|local_counter1|o_count\(18)))) ) )
...
-- Equation(s):
-- \send_ppm1|Equal0~1_combout\ = ( \send_ppm1|local_counter1|o_count\(11) & ( \send_ppm1|local_counter1|o_count\(12) & ( (!\send_ppm1|local_counter1|o_count\(7) & (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(14) & 
-- !\send_ppm1|local_counter1|o_count\(13)))) ) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(13),
...
-- Equation(s):
-- \send_ppm1|Equal0~3_combout\ = ( !\send_ppm1|local_counter1|o_count\(16) & ( !\send_ppm1|local_counter1|o_count\(19) & ( (!\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|local_counter1|o_count\(18) & (\send_ppm1|local_counter1|o_count\(0) & 
-- !\send_ppm1|local_counter1|o_count\(15)))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(18),
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(0),
...
-- Equation(s):
-- \send_ppm1|Equal0~0_combout\ = ( \send_ppm1|local_counter1|o_count\(6) & ( !\send_ppm1|local_counter1|o_count\(5) ) )
...
-- Equation(s):
-- \send_ppm1|sig_state~4_combout\ = ( \send_ppm1|sig_state\(0) & ( (\i_reset_n_top~input_o\ & (\send_ppm1|current_state.tempo~q\ & !\send_ppm1|sig_state\(1))) ) ) # ( !\send_ppm1|sig_state\(0) & ( (\i_reset_n_top~input_o\ & 
-- (\send_ppm1|current_state.tempo~q\ & \send_ppm1|sig_state\(1))) ) )
...
-- Equation(s):
-- \send_ppm1|sig_state~0_combout\ = ( \send_ppm1|sig_state\(1) & ( (\i_reset_n_top~input_o\ & (\send_ppm1|current_state.tempo~q\ & (!\send_ppm1|sig_state\(0) $ (!\send_ppm1|sig_state\(2))))) ) ) # ( !\send_ppm1|sig_state\(1) & ( (\i_reset_n_top~input_o\ & 
-- (\send_ppm1|current_state.tempo~q\ & \send_ppm1|sig_state\(2))) ) )
...
PORT MAP (
	dataa => \ALT_INV_i_reset_n_top~input_o\,
	datab => \send_ppm1|ALT_INV_current_state.tempo~q\,
...
-- Equation(s):
-- \send_ppm1|next_state~3_combout\ = ( \send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|Add1~49_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add1~45_sumout\ & (!\send_ppm1|Add1~41_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(7))))) # (\send_ppm1|local_counter1|o_count\(8) & (\send_ppm1|Add1~45_sumout\ & (!\send_ppm1|Add1~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(9) & ( 
-- !\send_ppm1|Add1~49_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add1~45_sumout\ & (!\send_ppm1|Add1~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) # (\send_ppm1|local_counter1|o_count\(8) & (\send_ppm1|Add1~45_sumout\ & 
-- (!\send_ppm1|Add1~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(7))))) ) ) )
...
PORT MAP (
	...
	dataf => \send_ppm1|ALT_INV_Add1~49_sumout\,
...
PORT MAP (
	...
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(13),
	combout => \send_ppm1|Equal3~1_combout\);

-- Location: LABCELL_X33_Y29_N57
\send_ppm1|next_state~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~1_combout\ = ( \send_ppm1|Add1~17_sumout\ & ( \send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|Add1~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ 
-- (\send_ppm1|Add1~13_sumout\)))) # (\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|Add1~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add1~13_sumout\)))) ) ) ) # ( !\send_ppm1|Add1~17_sumout\ & ( 
-- !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|Add1~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add1~13_sumout\)))) # (\send_ppm1|local_counter1|o_count\(14) & 
-- (\send_ppm1|Add1~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add1~13_sumout\)))) ) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add1~13_sumout\,
	datae => \send_ppm1|ALT_INV_Add1~17_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal3~0_combout\ = ( \send_ppm1|Add1~5_sumout\ & ( !\send_ppm1|local_counter1|o_count\(12) ) ) # ( !\send_ppm1|Add1~5_sumout\ & ( \send_ppm1|local_counter1|o_count\(12) ) )
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_Add1~5_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~5_combout\ = ( \send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|next_state~4_combout\ & ( (\send_ppm1|Add1~53_sumout\ & (!\send_ppm1|local_counter1|o_count\(15) $ (\send_ppm1|Add1~57_sumout\))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|next_state~4_combout\ & ( (!\send_ppm1|Add1~53_sumout\ & (!\send_ppm1|local_counter1|o_count\(15) $ (\send_ppm1|Add1~57_sumout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add1~29_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal3~4_combout\ = ( !\send_ppm1|Add1~33_sumout\ & ( \send_ppm1|local_counter1|o_count\(2) ) ) # ( \send_ppm1|Add1~33_sumout\ & ( !\send_ppm1|local_counter1|o_count\(2) ) )
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add1~33_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal3~2_combout\ = !\send_ppm1|Add1~25_sumout\ $ (!\send_ppm1|local_counter1|o_count\(0))
...
-- Equation(s):
-- \send_ppm1|next_state~2_combout\ = ( !\send_ppm1|Equal3~4_combout\ & ( !\send_ppm1|Equal3~2_combout\ & ( (!\send_ppm1|Equal3~3_combout\ & (!\send_ppm1|sig_state\(1) & (!\send_ppm1|Add1~37_sumout\ $ (\send_ppm1|local_counter1|o_count\(3))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1000000000001000000000000000000000000000000000000000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal3~3_combout\,
	datab => \send_ppm1|ALT_INV_sig_state\(1),
	datac => \send_ppm1|ALT_INV_Add1~37_sumout\,
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(3),
	datae => \send_ppm1|ALT_INV_Equal3~4_combout\,
	dataf => \send_ppm1|ALT_INV_Equal3~2_combout\,
	combout => \send_ppm1|next_state~2_combout\);

-- Location: MLABCELL_X34_Y29_N51
\send_ppm1|next_state~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~6_combout\ = ( \send_ppm1|next_state~5_combout\ & ( \send_ppm1|next_state~2_combout\ & ( (\send_ppm1|next_state~3_combout\ & (!\send_ppm1|Equal3~1_combout\ & (\send_ppm1|next_state~1_combout\ & !\send_ppm1|Equal3~0_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_next_state~3_combout\,
	datab => \send_ppm1|ALT_INV_Equal3~1_combout\,
	datac => \send_ppm1|ALT_INV_next_state~1_combout\,
	datad => \send_ppm1|ALT_INV_Equal3~0_combout\,
	datae => \send_ppm1|ALT_INV_next_state~5_combout\,
...
-- Equation(s):
-- \send_ppm1|Equal7~3_combout\ = ( \send_ppm1|Add5~29_sumout\ & ( !\send_ppm1|local_counter1|o_count\(1) ) ) # ( !\send_ppm1|Add5~29_sumout\ & ( \send_ppm1|local_counter1|o_count\(1) ) )
...
PORT MAP (
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(1),
	dataf => \send_ppm1|ALT_INV_Add5~29_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~9_combout\ = ( !\send_ppm1|Equal7~2_combout\ & ( !\send_ppm1|Equal7~4_combout\ & ( (\send_ppm1|sig_state\(1) & (!\send_ppm1|Equal7~3_combout\ & (!\send_ppm1|local_counter1|o_count\(3) $ (\send_ppm1|Add5~37_sumout\)))) ) ) )
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Equal7~3_combout\,
	datad => \send_ppm1|ALT_INV_Add5~37_sumout\,
	datae => \send_ppm1|ALT_INV_Equal7~2_combout\,
...
-- Equation(s):
-- \send_ppm1|next_state~10_combout\ = ( \send_ppm1|Add5~53_sumout\ & ( (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|local_counter1|o_count\(7) $ (\send_ppm1|Add5~49_sumout\))) ) ) # ( !\send_ppm1|Add5~53_sumout\ & ( 
-- (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|local_counter1|o_count\(7) $ (\send_ppm1|Add5~49_sumout\))) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add5~49_sumout\,
	dataf => \send_ppm1|ALT_INV_Add5~53_sumout\,
	combout => \send_ppm1|next_state~10_combout\);

-- Location: MLABCELL_X34_Y30_N24
\send_ppm1|next_state~11\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~11_combout\ = ( \send_ppm1|local_counter1|o_count\(4) & ( \send_ppm1|Add5~65_sumout\ & ( (\send_ppm1|local_counter1|o_count\(6) & (\send_ppm1|Add5~57_sumout\ & (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add5~61_sumout\)))) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(4) & ( \send_ppm1|Add5~65_sumout\ & ( (\send_ppm1|local_counter1|o_count\(6) & (!\send_ppm1|Add5~57_sumout\ & (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add5~61_sumout\)))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(4) & ( !\send_ppm1|Add5~65_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(6) & (\send_ppm1|Add5~57_sumout\ & (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add5~61_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(4) & ( !\send_ppm1|Add5~65_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(6) & (!\send_ppm1|Add5~57_sumout\ & (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add5~61_sumout\)))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(5),
	datac => \send_ppm1|ALT_INV_Add5~57_sumout\,
	datad => \send_ppm1|ALT_INV_Add5~61_sumout\,
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(4),
	dataf => \send_ppm1|ALT_INV_Add5~65_sumout\,
	combout => \send_ppm1|next_state~11_combout\);

-- Location: MLABCELL_X34_Y30_N33
\send_ppm1|next_state~12\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~12_combout\ = ( \send_ppm1|Add5~41_sumout\ & ( \send_ppm1|next_state~11_combout\ & ( (\send_ppm1|local_counter1|o_count\(9) & (\send_ppm1|next_state~10_combout\ & (!\send_ppm1|local_counter1|o_count\(15) $ 
-- (\send_ppm1|Add5~45_sumout\)))) ) ) ) # ( !\send_ppm1|Add5~41_sumout\ & ( \send_ppm1|next_state~11_combout\ & ( (!\send_ppm1|local_counter1|o_count\(9) & (\send_ppm1|next_state~10_combout\ & (!\send_ppm1|local_counter1|o_count\(15) $ 
-- (\send_ppm1|Add5~45_sumout\)))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(9),
	datab => \send_ppm1|ALT_INV_next_state~10_combout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(15),
	datad => \send_ppm1|ALT_INV_Add5~45_sumout\,
	datae => \send_ppm1|ALT_INV_Add5~41_sumout\,
...
PORT MAP (
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(13),
	dataf => \send_ppm1|ALT_INV_Add5~5_sumout\,
	combout => \send_ppm1|Equal7~1_combout\);

-- Location: LABCELL_X30_Y30_N54
\send_ppm1|next_state~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~8_combout\ = ( \send_ppm1|local_counter1|o_count\(10) & ( \send_ppm1|Add5~21_sumout\ & ( (\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|Add5~13_sumout\ & (!\send_ppm1|Add5~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(10) & ( \send_ppm1|Add5~21_sumout\ & ( (\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|Add5~13_sumout\ & (!\send_ppm1|Add5~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( \send_ppm1|local_counter1|o_count\(10) & ( !\send_ppm1|Add5~21_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|Add5~13_sumout\ & (!\send_ppm1|Add5~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(10) & ( !\send_ppm1|Add5~21_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|Add5~13_sumout\ & (!\send_ppm1|Add5~17_sumout\ $ 
...
PORT MAP (
	...
	dataf => \send_ppm1|ALT_INV_Add5~21_sumout\,
	combout => \send_ppm1|next_state~8_combout\);

-- Location: LABCELL_X35_Y30_N27
\send_ppm1|next_state~7\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~7_combout\ = ( \send_ppm1|local_counter1|o_count\(16) & ( (\send_ppm1|local_counter1|o_count\(19) & (\send_ppm1|local_counter1|o_count\(17) & (\send_ppm1|local_counter1|o_count\(18) & !\send_ppm1|Add5~9_sumout\))) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(16) & ( (!\send_ppm1|local_counter1|o_count\(19) & (!\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|local_counter1|o_count\(18) & \send_ppm1|Add5~9_sumout\))) ) )
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(12),
	dataf => \send_ppm1|ALT_INV_Add5~1_sumout\,
	combout => \send_ppm1|Equal7~0_combout\);

-- Location: LABCELL_X35_Y30_N6
\send_ppm1|next_state~13\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~13_combout\ = ( \send_ppm1|next_state~7_combout\ & ( !\send_ppm1|Equal7~0_combout\ & ( (\send_ppm1|next_state~9_combout\ & (\send_ppm1|next_state~12_combout\ & (!\send_ppm1|Equal7~1_combout\ & \send_ppm1|next_state~8_combout\))) ) ) 
-- )
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_next_state~12_combout\,
	datac => \send_ppm1|ALT_INV_Equal7~1_combout\,
	datad => \send_ppm1|ALT_INV_next_state~8_combout\,
	datae => \send_ppm1|ALT_INV_next_state~7_combout\,
...
-- Equation(s):
-- \send_ppm1|next_state~14_combout\ = ( !\send_ppm1|Add3~9_sumout\ & ( \send_ppm1|local_counter1|o_count\(18) & ( (\send_ppm1|local_counter1|o_count\(16) & (\send_ppm1|local_counter1|o_count\(19) & \send_ppm1|local_counter1|o_count\(17))) ) ) ) # ( 
-- \send_ppm1|Add3~9_sumout\ & ( !\send_ppm1|local_counter1|o_count\(18) & ( (!\send_ppm1|local_counter1|o_count\(16) & (!\send_ppm1|local_counter1|o_count\(19) & !\send_ppm1|local_counter1|o_count\(17))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000100000001000000000000001000000010000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(16),
	...
	datae => \send_ppm1|ALT_INV_Add3~9_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(18),
	combout => \send_ppm1|next_state~14_combout\);

-- Location: LABCELL_X35_Y29_N9
\send_ppm1|Equal5~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|Equal5~1_combout\ = ( !\send_ppm1|local_counter1|o_count\(13) & ( \send_ppm1|Add3~5_sumout\ ) ) # ( \send_ppm1|local_counter1|o_count\(13) & ( !\send_ppm1|Add3~5_sumout\ ) )
...
-- Equation(s):
-- \send_ppm1|next_state~15_combout\ = ( \send_ppm1|Add3~21_sumout\ & ( \send_ppm1|Add3~13_sumout\ & ( (\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|Add3~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( !\send_ppm1|Add3~21_sumout\ & ( \send_ppm1|Add3~13_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(14) & (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|Add3~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( \send_ppm1|Add3~21_sumout\ & ( !\send_ppm1|Add3~13_sumout\ & ( (\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|Add3~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( !\send_ppm1|Add3~21_sumout\ & ( !\send_ppm1|Add3~13_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|Add3~17_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(11))))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(14),
	datab => \send_ppm1|ALT_INV_Add3~17_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(10),
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(11),
	datae => \send_ppm1|ALT_INV_Add3~21_sumout\,
	dataf => \send_ppm1|ALT_INV_Add3~13_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~18_combout\ = ( \send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|Add3~65_sumout\ & ( (!\send_ppm1|Add3~57_sumout\ & (!\send_ppm1|local_counter1|o_count\(4) & (!\send_ppm1|local_counter1|o_count\(5) $ 
-- (\send_ppm1|Add3~61_sumout\)))) # (\send_ppm1|Add3~57_sumout\ & (\send_ppm1|local_counter1|o_count\(4) & (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add3~61_sumout\)))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(6) & ( 
-- !\send_ppm1|Add3~65_sumout\ & ( (!\send_ppm1|Add3~57_sumout\ & (!\send_ppm1|local_counter1|o_count\(4) & (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add3~61_sumout\)))) # (\send_ppm1|Add3~57_sumout\ & (\send_ppm1|local_counter1|o_count\(4) & 
-- (!\send_ppm1|local_counter1|o_count\(5) $ (\send_ppm1|Add3~61_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~57_sumout\,
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(4),
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(5),
	datad => \send_ppm1|ALT_INV_Add3~61_sumout\,
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(6),
	dataf => \send_ppm1|ALT_INV_Add3~65_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal5~3_combout\ = ( \send_ppm1|Add3~29_sumout\ & ( !\send_ppm1|local_counter1|o_count\(1) ) ) # ( !\send_ppm1|Add3~29_sumout\ & ( \send_ppm1|local_counter1|o_count\(1) ) )
...
-- Equation(s):
-- \send_ppm1|next_state~16_combout\ = ( !\send_ppm1|Equal5~4_combout\ & ( !\send_ppm1|Equal5~2_combout\ & ( (!\send_ppm1|Equal5~3_combout\ & (\send_ppm1|sig_state\(1) & (!\send_ppm1|Equal5~5_combout\ & !\send_ppm1|sig_state\(0)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal5~3_combout\,
	datab => \send_ppm1|ALT_INV_sig_state\(1),
	datac => \send_ppm1|ALT_INV_Equal5~5_combout\,
	datad => \send_ppm1|ALT_INV_sig_state\(0),
	datae => \send_ppm1|ALT_INV_Equal5~4_combout\,
	dataf => \send_ppm1|ALT_INV_Equal5~2_combout\,
	combout => \send_ppm1|next_state~16_combout\);

-- Location: LABCELL_X35_Y29_N30
\send_ppm1|next_state~20\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~20_combout\ = ( \send_ppm1|next_state~19_combout\ & ( \send_ppm1|next_state~16_combout\ & ( (\send_ppm1|next_state~14_combout\ & (!\send_ppm1|Equal5~1_combout\ & (\send_ppm1|next_state~15_combout\ & !\send_ppm1|Equal5~0_combout\))) ) 
-- ) )
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_next_state~19_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~16_combout\,
	combout => \send_ppm1|next_state~20_combout\);

-- Location: LABCELL_X35_Y30_N33
\send_ppm1|next_state~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~0_combout\ = ( \send_ppm1|Add1~1_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(19) & (!\send_ppm1|local_counter1|o_count\(18) & (!\send_ppm1|local_counter1|o_count\(16) & !\send_ppm1|local_counter1|o_count\(17)))) ) ) # ( 
-- !\send_ppm1|Add1~1_sumout\ & ( (\send_ppm1|local_counter1|o_count\(19) & (\send_ppm1|local_counter1|o_count\(18) & (\send_ppm1|local_counter1|o_count\(16) & \send_ppm1|local_counter1|o_count\(17)))) ) )
...
-- Equation(s):
-- \send_ppm1|next_state~21_combout\ = ( \send_ppm1|next_state~20_combout\ & ( \send_ppm1|next_state~0_combout\ & ( !\send_ppm1|sig_state\(2) ) ) ) # ( !\send_ppm1|next_state~20_combout\ & ( \send_ppm1|next_state~0_combout\ & ( (!\send_ppm1|sig_state\(2) & 
-- (\send_ppm1|sig_state\(0) & ((\send_ppm1|next_state~13_combout\) # (\send_ppm1|next_state~6_combout\)))) ) ) ) # ( \send_ppm1|next_state~20_combout\ & ( !\send_ppm1|next_state~0_combout\ & ( !\send_ppm1|sig_state\(2) ) ) ) # ( 
-- !\send_ppm1|next_state~20_combout\ & ( !\send_ppm1|next_state~0_combout\ & ( (!\send_ppm1|sig_state\(2) & (\send_ppm1|sig_state\(0) & \send_ppm1|next_state~13_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000100010101010101010101000000010001000101010101010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_next_state~13_combout\,
...
-- Equation(s):
-- \send_ppm1|Equal0~2_combout\ = ( !\send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|local_counter1|o_count\(1) & ( (!\send_ppm1|local_counter1|o_count\(2) & (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|local_counter1|o_count\(4) & 
-- \send_ppm1|local_counter1|o_count\(3)))) ) ) )
...
-- Equation(s):
-- \send_ppm1|current_state~10_combout\ = ( \send_ppm1|current_state.tempo~q\ & ( \send_ppm1|Equal0~2_combout\ & ( (\send_ppm1|Equal0~0_combout\ & (\send_ppm1|Equal0~3_combout\ & \send_ppm1|Equal0~1_combout\)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal0~0_combout\,
	datab => \send_ppm1|ALT_INV_Equal0~3_combout\,
	datac => \send_ppm1|ALT_INV_Equal0~1_combout\,
	datae => \send_ppm1|ALT_INV_current_state.tempo~q\,
	dataf => \send_ppm1|ALT_INV_Equal0~2_combout\,
	combout => \send_ppm1|current_state~10_combout\);

-- Location: LABCELL_X35_Y30_N12
\send_ppm1|current_state~11\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|current_state~11_combout\ = ( \send_ppm1|current_state.pulse~q\ & ( \send_ppm1|current_state~10_combout\ & ( (\i_reset_n_top~input_o\ & ((!\send_ppm1|Equal1~0_combout\) # ((!\send_ppm1|combi~6_combout\ & !\send_ppm1|next_state~21_combout\)))) ) 
-- ) ) # ( !\send_ppm1|current_state.pulse~q\ & ( \send_ppm1|current_state~10_combout\ & ( (!\send_ppm1|Equal1~0_combout\ & \i_reset_n_top~input_o\) ) ) ) # ( \send_ppm1|current_state.pulse~q\ & ( !\send_ppm1|current_state~10_combout\ & ( 
-- (!\send_ppm1|combi~6_combout\ & (!\send_ppm1|next_state~21_combout\ & \i_reset_n_top~input_o\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000001010000000000000110011000000000011101100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_combi~6_combout\,
	datab => \send_ppm1|ALT_INV_Equal1~0_combout\,
	datac => \send_ppm1|ALT_INV_next_state~21_combout\,
	datad => \ALT_INV_i_reset_n_top~input_o\,
	datae => \send_ppm1|ALT_INV_current_state.pulse~q\,
	dataf => \send_ppm1|ALT_INV_current_state~10_combout\,
...
-- Equation(s):
-- \send_ppm1|Equal0~4_combout\ = ( \send_ppm1|Equal0~1_combout\ & ( \send_ppm1|Equal0~2_combout\ & ( (\send_ppm1|Equal0~3_combout\ & \send_ppm1|Equal0~0_combout\) ) ) )
...
-- Equation(s):
-- \send_ppm1|sig_state[2]~1_combout\ = ( \send_ppm1|sig_state\(2) & ( \send_ppm1|Equal0~4_combout\ & ( (!\send_ppm1|current_state.pulse~q\ & (((!\send_ppm1|current_state.tempo~q\) # (\send_ppm1|sig_state\(0))) # (\send_ppm1|sig_state\(1)))) ) ) ) # ( 
-- !\send_ppm1|sig_state\(2) & ( \send_ppm1|Equal0~4_combout\ & ( !\send_ppm1|current_state.pulse~q\ ) ) ) # ( \send_ppm1|sig_state\(2) & ( !\send_ppm1|Equal0~4_combout\ & ( (!\send_ppm1|current_state.tempo~q\ & !\send_ppm1|current_state.pulse~q\) ) ) ) # ( 
-- !\send_ppm1|sig_state\(2) & ( !\send_ppm1|Equal0~4_combout\ & ( (!\send_ppm1|current_state.tempo~q\ & !\send_ppm1|current_state.pulse~q\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000000000110011000000000011111111000000001101111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_sig_state\(1),
	datab => \send_ppm1|ALT_INV_current_state.tempo~q\,
	datac => \send_ppm1|ALT_INV_sig_state\(0),
	datad => \send_ppm1|ALT_INV_current_state.pulse~q\,
...
-- Equation(s):
-- \send_ppm1|sig_state[2]~2_combout\ = ( \send_ppm1|Equal9~7_combout\ & ( \send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((\send_ppm1|sig_state[2]~1_combout\ & ((!\send_ppm1|current_state.synchro~q\) # (\send_ppm1|Equal9~8_combout\)))) ) ) ) 
-- # ( !\send_ppm1|Equal9~7_combout\ & ( \send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((!\send_ppm1|current_state.synchro~q\ & \send_ppm1|sig_state[2]~1_combout\)) ) ) ) # ( \send_ppm1|Equal9~7_combout\ & ( !\send_ppm1|Equal9~5_combout\ & ( 
-- (!\i_reset_n_top~input_o\) # ((!\send_ppm1|current_state.synchro~q\ & \send_ppm1|sig_state[2]~1_combout\)) ) ) ) # ( !\send_ppm1|Equal9~7_combout\ & ( !\send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((!\send_ppm1|current_state.synchro~q\ & 
-- \send_ppm1|sig_state[2]~1_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011101110110011001110111011001100111011101100110011101111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_current_state.synchro~q\,
	...
	datad => \send_ppm1|ALT_INV_sig_state[2]~1_combout\,
	datae => \send_ppm1|ALT_INV_Equal9~7_combout\,
...
-- Equation(s):
-- \send_ppm1|current_state~12_combout\ = ( \send_ppm1|current_state.tempo~q\ & ( \send_ppm1|Equal0~2_combout\ & ( (\send_ppm1|Equal0~1_combout\ & (\send_ppm1|Equal0~3_combout\ & (\send_ppm1|Equal0~0_combout\ & \send_ppm1|Equal1~0_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal0~1_combout\,
	datab => \send_ppm1|ALT_INV_Equal0~3_combout\,
	datac => \send_ppm1|ALT_INV_Equal0~0_combout\,
	datad => \send_ppm1|ALT_INV_Equal1~0_combout\,
	datae => \send_ppm1|ALT_INV_current_state.tempo~q\,
	dataf => \send_ppm1|ALT_INV_Equal0~2_combout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal9~8_combout\,
...
-- Equation(s):
-- \send_ppm1|current_state~7_combout\ = ( \send_ppm1|Equal0~1_combout\ & ( \send_ppm1|Equal0~2_combout\ & ( (\send_ppm1|current_state.tempo~q\ & ((!\send_ppm1|Equal0~3_combout\) # (!\send_ppm1|Equal0~0_combout\))) ) ) ) # ( !\send_ppm1|Equal0~1_combout\ & ( 
-- \send_ppm1|Equal0~2_combout\ & ( \send_ppm1|current_state.tempo~q\ ) ) ) # ( \send_ppm1|Equal0~1_combout\ & ( !\send_ppm1|Equal0~2_combout\ & ( \send_ppm1|current_state.tempo~q\ ) ) ) # ( !\send_ppm1|Equal0~1_combout\ & ( !\send_ppm1|Equal0~2_combout\ & ( 
...
-- Equation(s):
-- \send_ppm1|next_state~22_combout\ = ( \send_ppm1|Add5~49_sumout\ & ( \send_ppm1|Add5~53_sumout\ & ( (\send_ppm1|local_counter1|o_count\(7) & (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add5~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) 
-- ) ) ) # ( !\send_ppm1|Add5~49_sumout\ & ( \send_ppm1|Add5~53_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(7) & (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add5~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) ) # ( 
-- \send_ppm1|Add5~49_sumout\ & ( !\send_ppm1|Add5~53_sumout\ & ( (\send_ppm1|local_counter1|o_count\(7) & (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add5~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) ) # ( 
-- !\send_ppm1|Add5~49_sumout\ & ( !\send_ppm1|Add5~53_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(7) & (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|Add5~41_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) )
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_Add5~49_sumout\,
	dataf => \send_ppm1|ALT_INV_Add5~53_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~23_combout\ = ( !\send_ppm1|Equal7~5_combout\ & ( \send_ppm1|next_state~9_combout\ & ( (!\send_ppm1|Equal7~1_combout\ & (\send_ppm1|next_state~22_combout\ & (\send_ppm1|next_state~11_combout\ & !\send_ppm1|Equal7~0_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal7~1_combout\,
	datab => \send_ppm1|ALT_INV_next_state~22_combout\,
	datac => \send_ppm1|ALT_INV_next_state~11_combout\,
	datad => \send_ppm1|ALT_INV_Equal7~0_combout\,
	datae => \send_ppm1|ALT_INV_Equal7~5_combout\,
...
-- Equation(s):
-- \send_ppm1|next_state~24_combout\ = ( \send_ppm1|next_state~23_combout\ & ( \send_ppm1|next_state~6_combout\ & ( (\send_ppm1|sig_state\(0) & (((\send_ppm1|next_state~7_combout\ & \send_ppm1|next_state~8_combout\)) # (\send_ppm1|next_state~0_combout\))) ) 
...
-- (\send_ppm1|next_state~7_combout\ & (\send_ppm1|sig_state\(0) & \send_ppm1|next_state~8_combout\)) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_next_state~7_combout\,
	datab => \send_ppm1|ALT_INV_sig_state\(0),
	datac => \send_ppm1|ALT_INV_next_state~0_combout\,
	datad => \send_ppm1|ALT_INV_next_state~8_combout\,
...
-- Equation(s):
-- \send_ppm1|local_counter1|o_count[9]~0_combout\ = ( \send_ppm1|next_state~24_combout\ & ( \send_ppm1|next_state~20_combout\ & ( (!\send_ppm1|current_state~7_combout\ & ((!\send_ppm1|sig_state\(2)) # ((!\send_ppm1|current_state.pulse~q\) # 
-- (\send_ppm1|combi~6_combout\)))) ) ) ) # ( !\send_ppm1|next_state~24_combout\ & ( \send_ppm1|next_state~20_combout\ & ( (!\send_ppm1|current_state~7_combout\ & ((!\send_ppm1|sig_state\(2)) # ((!\send_ppm1|current_state.pulse~q\) # 
-- (\send_ppm1|combi~6_combout\)))) ) ) ) # ( \send_ppm1|next_state~24_combout\ & ( !\send_ppm1|next_state~20_combout\ & ( (!\send_ppm1|current_state~7_combout\ & ((!\send_ppm1|sig_state\(2)) # ((!\send_ppm1|current_state.pulse~q\) # 
-- (\send_ppm1|combi~6_combout\)))) ) ) ) # ( !\send_ppm1|next_state~24_combout\ & ( !\send_ppm1|next_state~20_combout\ & ( (!\send_ppm1|current_state~7_combout\ & ((!\send_ppm1|current_state.pulse~q\) # (\send_ppm1|combi~6_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100111100000000111011110000000011101111000000001110111100000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_sig_state\(2),
	datab => \send_ppm1|ALT_INV_current_state.pulse~q\,
	datac => \send_ppm1|ALT_INV_combi~6_combout\,
	datad => \send_ppm1|ALT_INV_current_state~7_combout\,
	datae => \send_ppm1|ALT_INV_next_state~24_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~20_combout\,
...
-- Equation(s):
-- \send_ppm1|local_counter1|o_count[9]~1_combout\ = ( \send_ppm1|Equal9~8_combout\ & ( \send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((\send_ppm1|local_counter1|o_count[9]~0_combout\ & ((!\send_ppm1|current_state.synchro~q\) # 
-- (\send_ppm1|Equal9~7_combout\)))) ) ) ) # ( !\send_ppm1|Equal9~8_combout\ & ( \send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((!\send_ppm1|current_state.synchro~q\ & \send_ppm1|local_counter1|o_count[9]~0_combout\)) ) ) ) # ( 
-- \send_ppm1|Equal9~8_combout\ & ( !\send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((!\send_ppm1|current_state.synchro~q\ & \send_ppm1|local_counter1|o_count[9]~0_combout\)) ) ) ) # ( !\send_ppm1|Equal9~8_combout\ & ( 
-- !\send_ppm1|Equal9~5_combout\ & ( (!\i_reset_n_top~input_o\) # ((!\send_ppm1|current_state.synchro~q\ & \send_ppm1|local_counter1|o_count[9]~0_combout\)) ) ) )
...
PORT MAP (
	clk => \i_clk_top~inputCLKENA0_outclk\,
	d => \send_ppm1|local_counter1|Add0~37_sumout\,
	sclr => \send_ppm1|local_counter1|o_count[9]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\send_ppm1|local_counter1|o_count[4]~feeder\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|local_counter1|o_count[4]~feeder_combout\ = ( \send_ppm1|local_counter1|Add0~73_sumout\ )
...
-- pragma translate_on
PORT MAP (
	dataf => \send_ppm1|local_counter1|ALT_INV_Add0~73_sumout\,
	combout => \send_ppm1|local_counter1|o_count[4]~feeder_combout\);

-- Location: FF_X37_Y31_N20
...
PORT MAP (
	clk => \i_clk_top~inputCLKENA0_outclk\,
	d => \send_ppm1|local_counter1|o_count[4]~feeder_combout\,
	sclr => \send_ppm1|local_counter1|o_count[9]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|combi~0_combout\ = ( \send_ppm1|Add7~5_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(19) & (!\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|local_counter1|o_count\(16) & !\send_ppm1|local_counter1|o_count\(18)))) ) ) # ( 
-- !\send_ppm1|Add7~5_sumout\ & ( (\send_ppm1|local_counter1|o_count\(19) & (\send_ppm1|local_counter1|o_count\(17) & (\send_ppm1|local_counter1|o_count\(16) & \send_ppm1|local_counter1|o_count\(18)))) ) )
...
-- Equation(s):
-- \send_ppm1|combi~4_combout\ = ( \send_ppm1|Add7~45_sumout\ & ( \send_ppm1|Add7~41_sumout\ & ( (\send_ppm1|local_counter1|o_count\(8) & (\send_ppm1|local_counter1|o_count\(7) & (!\send_ppm1|Add7~49_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) ) 
-- # ( !\send_ppm1|Add7~45_sumout\ & ( \send_ppm1|Add7~41_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(8) & (\send_ppm1|local_counter1|o_count\(7) & (!\send_ppm1|Add7~49_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) ) # ( 
-- \send_ppm1|Add7~45_sumout\ & ( !\send_ppm1|Add7~41_sumout\ & ( (\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|local_counter1|o_count\(7) & (!\send_ppm1|Add7~49_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) ) # ( 
-- !\send_ppm1|Add7~45_sumout\ & ( !\send_ppm1|Add7~41_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(8) & (!\send_ppm1|local_counter1|o_count\(7) & (!\send_ppm1|Add7~49_sumout\ $ (\send_ppm1|local_counter1|o_count\(9))))) ) ) )
...
-- Equation(s):
-- \send_ppm1|combi~1_combout\ = ( \send_ppm1|Add7~9_sumout\ & ( \send_ppm1|Add7~17_sumout\ & ( (\send_ppm1|local_counter1|o_count\(10) & (\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add7~13_sumout\)))) ) ) 
-- ) # ( !\send_ppm1|Add7~9_sumout\ & ( \send_ppm1|Add7~17_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(10) & (\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add7~13_sumout\)))) ) ) ) # ( 
-- \send_ppm1|Add7~9_sumout\ & ( !\send_ppm1|Add7~17_sumout\ & ( (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add7~13_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|Add7~9_sumout\ & ( !\send_ppm1|Add7~17_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|local_counter1|o_count\(14) & (!\send_ppm1|local_counter1|o_count\(11) $ (\send_ppm1|Add7~13_sumout\)))) ) ) )
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_Add7~9_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal8~5_combout\ = ( \send_ppm1|Add7~57_sumout\ & ( !\send_ppm1|local_counter1|o_count\(5) ) ) # ( !\send_ppm1|Add7~57_sumout\ & ( \send_ppm1|local_counter1|o_count\(5) ) )
...
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(5),
	dataf => \send_ppm1|ALT_INV_Add7~57_sumout\,
...
-- Equation(s):
-- \send_ppm1|combi~5_combout\ = ( !\send_ppm1|Equal8~5_combout\ & ( !\send_ppm1|Equal8~4_combout\ & ( (!\send_ppm1|local_counter1|o_count\(6) & (!\send_ppm1|Add7~61_sumout\ & (!\send_ppm1|local_counter1|o_count\(15) $ (\send_ppm1|Add7~65_sumout\)))) # 
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_Equal8~5_combout\,
	dataf => \send_ppm1|ALT_INV_Equal8~4_combout\,
	combout => \send_ppm1|combi~5_combout\);

-- Location: LABCELL_X37_Y31_N24
\send_ppm1|Equal8~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|Equal8~2_combout\ = ( !\send_ppm1|Add7~25_sumout\ & ( \send_ppm1|local_counter1|o_count\(2) ) ) # ( \send_ppm1|Add7~25_sumout\ & ( !\send_ppm1|local_counter1|o_count\(2) ) )
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add7~25_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(2),
...
-- Equation(s):
-- \send_ppm1|combi~2_combout\ = ( !\send_ppm1|sig_state\(1) & ( (\send_ppm1|sig_state\(2) & (!\send_ppm1|sig_state\(0) & (!\send_ppm1|local_counter1|o_count\(0) $ (\send_ppm1|Add7~37_sumout\)))) ) )
...
-- Equation(s):
-- \send_ppm1|Equal8~1_combout\ = ( \send_ppm1|Add7~21_sumout\ & ( !\send_ppm1|local_counter1|o_count\(1) ) ) # ( !\send_ppm1|Add7~21_sumout\ & ( \send_ppm1|local_counter1|o_count\(1) ) )
...
PORT MAP (
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(1),
	datae => \send_ppm1|ALT_INV_Add7~21_sumout\,
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add7~29_sumout\,
...
-- Equation(s):
-- \send_ppm1|combi~6_combout\ = ( \send_ppm1|combi~5_combout\ & ( \send_ppm1|combi~3_combout\ & ( (\send_ppm1|combi~0_combout\ & (\send_ppm1|combi~4_combout\ & (!\send_ppm1|Equal8~0_combout\ & \send_ppm1|combi~1_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_combi~0_combout\,
	datab => \send_ppm1|ALT_INV_combi~4_combout\,
	datac => \send_ppm1|ALT_INV_Equal8~0_combout\,
	datad => \send_ppm1|ALT_INV_combi~1_combout\,
...
-- Equation(s):
-- \send_ppm1|current_state~8_combout\ = ( \send_ppm1|next_state~21_combout\ & ( \i_reset_n_top~input_o\ & ( ((\send_ppm1|current_state.pulse~q\) # (\send_ppm1|reg~2_combout\)) # (\send_ppm1|current_state~7_combout\) ) ) ) # ( 
-- !\send_ppm1|next_state~21_combout\ & ( \i_reset_n_top~input_o\ & ( (((\send_ppm1|combi~6_combout\ & \send_ppm1|current_state.pulse~q\)) # (\send_ppm1|reg~2_combout\)) # (\send_ppm1|current_state~7_combout\) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000111111011111110011111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_combi~6_combout\,
	datab => \send_ppm1|ALT_INV_current_state~7_combout\,
	datac => \send_ppm1|ALT_INV_reg~2_combout\,
	datad => \send_ppm1|ALT_INV_current_state.pulse~q\,
	datae => \send_ppm1|ALT_INV_next_state~21_combout\,
...
-- Equation(s):
-- \send_ppm1|sig_out_ppm~0_combout\ = ( \send_ppm1|current_state.tempo~q\ & ( \i_reset_n_top~input_o\ ) )
