...
-- o_ppm_top	=>  Location: PIN_AB17,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
-- i_sel_top[0]	=>  Location: PIN_AE11,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_sel_top[3]	=>  Location: PIN_AE12,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_sel_top[1]	=>  Location: PIN_AC9,	 I/O Standard: 2.5 V,	 Current Strength: Default
-- i_sel_top[2]	=>  Location: PIN_AD10,	 I/O Standard: 2.5 V,	 Current Strength: Default
...
SIGNAL ww_i_sel_top : std_logic_vector(3 DOWNTO 0);
...
SIGNAL \sig_clk25~0_combout\ : std_logic;
SIGNAL \sig_clk25~q\ : std_logic;
...
SIGNAL \i_sel_top[2]~input_o\ : std_logic;
SIGNAL \i_sel_top[1]~input_o\ : std_logic;
SIGNAL \i_sel_top[3]~input_o\ : std_logic;
SIGNAL \decoder1|o_val[0]~3_combout\ : std_logic;
SIGNAL \decoder1|o_val~4_combout\ : std_logic;
...
SIGNAL \decoder1|o_val[10]~2_combout\ : std_logic;
...
SIGNAL \decoder1|o_val[0]~1_combout\ : std_logic;
...
SIGNAL \send_ppm1|local_counter1|o_count[17]~0_combout\ : std_logic;
SIGNAL \send_ppm1|local_counter1|o_count[17]~1_combout\ : std_logic;
...
SIGNAL \ALT_INV_i_sel_top[2]~input_o\ : std_logic;
SIGNAL \ALT_INV_i_sel_top[1]~input_o\ : std_logic;
SIGNAL \ALT_INV_i_sel_top[3]~input_o\ : std_logic;
...
SIGNAL \send_ppm1|local_counter1|ALT_INV_o_count[17]~0_combout\ : std_logic;
...
SIGNAL \ALT_INV_sig_clk25~q\ : std_logic;
...
\send_ppm1|Mult0~8_CLK_bus\ <= (gnd & gnd & \sig_clk25~q\);

\send_ppm1|Mult0~8_ENA_bus\ <= (vcc & vcc & \send_ppm1|reg~2_combout\);

\send_ppm1|Mult0~8_AX_bus\ <= (\decoder1|o_val[7]~0_combout\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\ & \i_sel_top[0]~input_o\);
...
\send_ppm1|Mult2~8_CLK_bus\ <= (gnd & gnd & \sig_clk25~q\);

\send_ppm1|Mult2~8_ENA_bus\ <= (vcc & vcc & \send_ppm1|reg~2_combout\);

\send_ppm1|Mult2~8_AX_bus\ <= (\i_sel_top[2]~input_o\ & \decoder1|o_val[0]~1_combout\ & \decoder1|o_val[0]~1_combout\ & \decoder1|o_val[0]~1_combout\ & \decoder1|o_val[0]~1_combout\ & \decoder1|o_val[0]~1_combout\ & \decoder1|o_val[0]~1_combout\ & 
\decoder1|o_val[0]~1_combout\);
...
\send_ppm1|Mult1~8_CLK_bus\ <= (gnd & gnd & \sig_clk25~q\);

\send_ppm1|Mult1~8_ENA_bus\ <= (vcc & vcc & \send_ppm1|reg~2_combout\);

\send_ppm1|Mult1~8_AX_bus\ <= (\i_sel_top[1]~input_o\ & \decoder1|o_val[10]~2_combout\ & \decoder1|o_val[10]~2_combout\ & \decoder1|o_val[10]~2_combout\ & \decoder1|o_val[10]~2_combout\ & \decoder1|o_val[10]~2_combout\ & \decoder1|o_val[10]~2_combout\ & 
\decoder1|o_val[10]~2_combout\);
...
\send_ppm1|Mult3~8_CLK_bus\ <= (gnd & gnd & \sig_clk25~q\);

\send_ppm1|Mult3~8_ENA_bus\ <= (vcc & vcc & \send_ppm1|reg~2_combout\);

\send_ppm1|Mult3~8_AX_bus\ <= (\decoder1|o_val~4_combout\ & \decoder1|o_val[0]~3_combout\ & \decoder1|o_val[0]~3_combout\ & \decoder1|o_val[0]~3_combout\ & \decoder1|o_val[0]~3_combout\ & \decoder1|o_val[0]~3_combout\ & \decoder1|o_val[0]~3_combout\ & 
\decoder1|o_val[0]~3_combout\);
...
\ALT_INV_i_sel_top[2]~input_o\ <= NOT \i_sel_top[2]~input_o\;
\ALT_INV_i_sel_top[1]~input_o\ <= NOT \i_sel_top[1]~input_o\;
\ALT_INV_i_sel_top[3]~input_o\ <= NOT \i_sel_top[3]~input_o\;
...
\send_ppm1|local_counter1|ALT_INV_o_count[17]~0_combout\ <= NOT \send_ppm1|local_counter1|o_count[17]~0_combout\;
...
\ALT_INV_sig_clk25~q\ <= NOT \sig_clk25~q\;
...
\sig_clk25~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \sig_clk25~0_combout\ = ( !\sig_clk25~q\ & ( \i_reset_n_top~input_o\ ) )
...
PORT MAP (
	...
	dataf => \ALT_INV_sig_clk25~q\,
	combout => \sig_clk25~0_combout\);
...
-- pragma translate_on
PORT MAP (
	clk => \i_clk_top~input_o\,
	asdata => \sig_clk25~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \sig_clk25~q\);
...
PORT MAP (
	...
	sclr => \send_ppm1|local_counter1|o_count[17]~1_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
\i_sel_top[2]~input\ : cyclonev_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
...
\i_sel_top[3]~input\ : cyclonev_io_ibuf
-- pragma translate_off
GENERIC MAP (
	bus_hold => "false",
	simulate_z_as => "z")
...
PORT MAP (
	i => ww_i_sel_top(3),
	o => \i_sel_top[3]~input_o\);

-- Location: LABCELL_X31_Y26_N51
\decoder1|o_val[0]~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoder1|o_val[0]~3_combout\ = ((\i_sel_top[0]~input_o\ & (!\i_sel_top[2]~input_o\ & !\i_sel_top[1]~input_o\))) # (\i_sel_top[3]~input_o\)

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0100000011111111010000001111111101000000111111110100000011111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_i_sel_top[0]~input_o\,
	datab => \ALT_INV_i_sel_top[2]~input_o\,
	datac => \ALT_INV_i_sel_top[1]~input_o\,
	datad => \ALT_INV_i_sel_top[3]~input_o\,
	combout => \decoder1|o_val[0]~3_combout\);

-- Location: LABCELL_X31_Y26_N42
\decoder1|o_val~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoder1|o_val~4_combout\ = ( \i_sel_top[2]~input_o\ & ( (\i_sel_top[3]~input_o\ & ((!\i_sel_top[0]~input_o\) # (!\i_sel_top[1]~input_o\))) ) ) # ( !\i_sel_top[2]~input_o\ & ( \i_sel_top[3]~input_o\ ) )
...
PORT MAP (
	dataa => \ALT_INV_i_sel_top[0]~input_o\,
	datab => \ALT_INV_i_sel_top[1]~input_o\,
	datac => \ALT_INV_i_sel_top[3]~input_o\,
	datae => \ALT_INV_i_sel_top[2]~input_o\,
	combout => \decoder1|o_val~4_combout\);
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~11\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult3~12\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult3~9\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add6~17_sumout\,
...
\decoder1|o_val[10]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoder1|o_val[10]~2_combout\ = ( \i_sel_top[1]~input_o\ ) # ( !\i_sel_top[1]~input_o\ & ( (!\i_sel_top[2]~input_o\ & (\i_sel_top[0]~input_o\ & !\i_sel_top[3]~input_o\)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000110000000000000011000000000011111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \ALT_INV_i_sel_top[2]~input_o\,
	datac => \ALT_INV_i_sel_top[0]~input_o\,
	datad => \ALT_INV_i_sel_top[3]~input_o\,
	dataf => \ALT_INV_i_sel_top[1]~input_o\,
	combout => \decoder1|o_val[10]~2_combout\);
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult1~11\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add2~21_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add2~25_sumout\,
...
-- Equation(s):
-- \decoder1|o_val[7]~0_combout\ = ( \i_sel_top[1]~input_o\ & ( \i_sel_top[0]~input_o\ ) ) # ( !\i_sel_top[1]~input_o\ & ( (\i_sel_top[0]~input_o\ & ((\i_sel_top[3]~input_o\) # (\i_sel_top[2]~input_o\))) ) )
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult0~12\,
...
\decoder1|o_val[0]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \decoder1|o_val[0]~1_combout\ = ((\i_sel_top[0]~input_o\ & (!\i_sel_top[1]~input_o\ & !\i_sel_top[3]~input_o\))) # (\i_sel_top[2]~input_o\)

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0111001100110011011100110011001101110011001100110111001100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_i_sel_top[0]~input_o\,
	...
	datac => \ALT_INV_i_sel_top[1]~input_o\,
	datad => \ALT_INV_i_sel_top[3]~input_o\,
	combout => \decoder1|o_val[0]~1_combout\);
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult2~10\,
	cin => GND,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult2~11\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult2~12\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult2~9\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~21_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~1_sumout\ = SUM(( !\send_ppm1|Add3~25_sumout\ $ (!\send_ppm1|Add5~25_sumout\ $ (\send_ppm1|Add1~25_sumout\)) ) + ( !VCC ) + ( !VCC ))
-- \send_ppm1|Add8~2\ = CARRY(( !\send_ppm1|Add3~25_sumout\ $ (!\send_ppm1|Add5~25_sumout\ $ (\send_ppm1|Add1~25_sumout\)) ) + ( !VCC ) + ( !VCC ))
-- \send_ppm1|Add8~3\ = SHARE((!\send_ppm1|Add3~25_sumout\ & (\send_ppm1|Add5~25_sumout\ & \send_ppm1|Add1~25_sumout\)) # (\send_ppm1|Add3~25_sumout\ & ((\send_ppm1|Add1~25_sumout\) # (\send_ppm1|Add5~25_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~25_sumout\,
	datac => \send_ppm1|ALT_INV_Add5~25_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~25_sumout\,
	cin => GND,
	sharein => GND,
...
-- Equation(s):
-- \send_ppm1|Add8~5_sumout\ = SUM(( !\send_ppm1|Add3~29_sumout\ $ (!\send_ppm1|Add5~29_sumout\ $ (\send_ppm1|Add1~29_sumout\)) ) + ( \send_ppm1|Add8~3\ ) + ( \send_ppm1|Add8~2\ ))
-- \send_ppm1|Add8~6\ = CARRY(( !\send_ppm1|Add3~29_sumout\ $ (!\send_ppm1|Add5~29_sumout\ $ (\send_ppm1|Add1~29_sumout\)) ) + ( \send_ppm1|Add8~3\ ) + ( \send_ppm1|Add8~2\ ))
-- \send_ppm1|Add8~7\ = SHARE((!\send_ppm1|Add3~29_sumout\ & (\send_ppm1|Add5~29_sumout\ & \send_ppm1|Add1~29_sumout\)) # (\send_ppm1|Add3~29_sumout\ & ((\send_ppm1|Add1~29_sumout\) # (\send_ppm1|Add5~29_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~29_sumout\,
	datac => \send_ppm1|ALT_INV_Add5~29_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~29_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~29_sumout\ = SUM(( !\send_ppm1|Add3~37_sumout\ $ (!\send_ppm1|Add5~37_sumout\ $ (\send_ppm1|Add1~37_sumout\)) ) + ( \send_ppm1|Add8~39\ ) + ( \send_ppm1|Add8~38\ ))
-- \send_ppm1|Add8~30\ = CARRY(( !\send_ppm1|Add3~37_sumout\ $ (!\send_ppm1|Add5~37_sumout\ $ (\send_ppm1|Add1~37_sumout\)) ) + ( \send_ppm1|Add8~39\ ) + ( \send_ppm1|Add8~38\ ))
-- \send_ppm1|Add8~31\ = SHARE((!\send_ppm1|Add3~37_sumout\ & (\send_ppm1|Add5~37_sumout\ & \send_ppm1|Add1~37_sumout\)) # (\send_ppm1|Add3~37_sumout\ & ((\send_ppm1|Add1~37_sumout\) # (\send_ppm1|Add5~37_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~37_sumout\,
	datac => \send_ppm1|ALT_INV_Add5~37_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~37_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~61_sumout\ = SUM(( !\send_ppm1|Add3~57_sumout\ $ (!\send_ppm1|Add1~61_sumout\ $ (\send_ppm1|Add5~57_sumout\)) ) + ( \send_ppm1|Add8~31\ ) + ( \send_ppm1|Add8~30\ ))
-- \send_ppm1|Add8~62\ = CARRY(( !\send_ppm1|Add3~57_sumout\ $ (!\send_ppm1|Add1~61_sumout\ $ (\send_ppm1|Add5~57_sumout\)) ) + ( \send_ppm1|Add8~31\ ) + ( \send_ppm1|Add8~30\ ))
-- \send_ppm1|Add8~63\ = SHARE((!\send_ppm1|Add3~57_sumout\ & (\send_ppm1|Add1~61_sumout\ & \send_ppm1|Add5~57_sumout\)) # (\send_ppm1|Add3~57_sumout\ & ((\send_ppm1|Add5~57_sumout\) # (\send_ppm1|Add1~61_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~57_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~61_sumout\,
	datad => \send_ppm1|ALT_INV_Add5~57_sumout\,
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Add8~1_sumout\,
	cin => GND,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add7~21_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~37_sumout\ = SUM(( \send_ppm1|Add7~25_sumout\ ) + ( \send_ppm1|Add8~37_sumout\ ) + ( \send_ppm1|Add10~6\ ))
-- \send_ppm1|Add10~38\ = CARRY(( \send_ppm1|Add7~25_sumout\ ) + ( \send_ppm1|Add8~37_sumout\ ) + ( \send_ppm1|Add10~6\ ))
...
-- Equation(s):
-- \send_ppm1|Add10~29_sumout\ = SUM(( \send_ppm1|Add7~29_sumout\ ) + ( \send_ppm1|Add8~29_sumout\ ) + ( \send_ppm1|Add10~38\ ))
-- \send_ppm1|Add10~30\ = CARRY(( \send_ppm1|Add7~29_sumout\ ) + ( \send_ppm1|Add8~29_sumout\ ) + ( \send_ppm1|Add10~38\ ))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add8~29_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~29_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~61_sumout\ = SUM(( \send_ppm1|Add8~61_sumout\ ) + ( \send_ppm1|Add7~53_sumout\ ) + ( \send_ppm1|Add10~30\ ))
-- \send_ppm1|Add10~62\ = CARRY(( \send_ppm1|Add8~61_sumout\ ) + ( \send_ppm1|Add7~53_sumout\ ) + ( \send_ppm1|Add10~30\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add7~53_sumout\,
	datad => \send_ppm1|ALT_INV_Add8~61_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add10~1_sumout\,
	cin => GND,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add10~5_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add11~29_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~13\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult3~14\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add6~45_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add6~49_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add2~49_sumout\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add2~53_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~49_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult0~13\,
...
-- Equation(s):
-- \send_ppm1|Add8~65_sumout\ = SUM(( !\send_ppm1|Add3~61_sumout\ $ (!\send_ppm1|Add5~61_sumout\ $ (\send_ppm1|Add1~65_sumout\)) ) + ( \send_ppm1|Add8~63\ ) + ( \send_ppm1|Add8~62\ ))
-- \send_ppm1|Add8~66\ = CARRY(( !\send_ppm1|Add3~61_sumout\ $ (!\send_ppm1|Add5~61_sumout\ $ (\send_ppm1|Add1~65_sumout\)) ) + ( \send_ppm1|Add8~63\ ) + ( \send_ppm1|Add8~62\ ))
-- \send_ppm1|Add8~67\ = SHARE((!\send_ppm1|Add3~61_sumout\ & (\send_ppm1|Add5~61_sumout\ & \send_ppm1|Add1~65_sumout\)) # (\send_ppm1|Add3~61_sumout\ & ((\send_ppm1|Add1~65_sumout\) # (\send_ppm1|Add5~61_sumout\))))
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add1~65_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~69_sumout\ = SUM(( !\send_ppm1|Add3~65_sumout\ $ (!\send_ppm1|Add5~65_sumout\ $ (\send_ppm1|Add1~53_sumout\)) ) + ( \send_ppm1|Add8~67\ ) + ( \send_ppm1|Add8~66\ ))
-- \send_ppm1|Add8~70\ = CARRY(( !\send_ppm1|Add3~65_sumout\ $ (!\send_ppm1|Add5~65_sumout\ $ (\send_ppm1|Add1~53_sumout\)) ) + ( \send_ppm1|Add8~67\ ) + ( \send_ppm1|Add8~66\ ))
-- \send_ppm1|Add8~71\ = SHARE((!\send_ppm1|Add3~65_sumout\ & (\send_ppm1|Add5~65_sumout\ & \send_ppm1|Add1~53_sumout\)) # (\send_ppm1|Add3~65_sumout\ & ((\send_ppm1|Add1~53_sumout\) # (\send_ppm1|Add5~65_sumout\))))
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Add5~65_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~53_sumout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add8~65_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~69_sumout\ = SUM(( \send_ppm1|Add8~69_sumout\ ) + ( \send_ppm1|Add7~61_sumout\ ) + ( \send_ppm1|Add10~66\ ))
-- \send_ppm1|Add10~70\ = CARRY(( \send_ppm1|Add8~69_sumout\ ) + ( \send_ppm1|Add7~61_sumout\ ) + ( \send_ppm1|Add10~66\ ))
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add8~69_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~6_combout\ = ( \send_ppm1|Add12~69_sumout\ & ( \send_ppm1|Add12~65_sumout\ & ( (\send_ppm1|local_counter1|o_count\(6) & (\send_ppm1|local_counter1|o_count\(5) & (!\send_ppm1|local_counter1|o_count\(4) $ (\send_ppm1|Add12~61_sumout\)))) ) 
-- ) ) # ( !\send_ppm1|Add12~69_sumout\ & ( \send_ppm1|Add12~65_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(6) & (\send_ppm1|local_counter1|o_count\(5) & (!\send_ppm1|local_counter1|o_count\(4) $ (\send_ppm1|Add12~61_sumout\)))) ) ) ) # ( 
-- \send_ppm1|Add12~69_sumout\ & ( !\send_ppm1|Add12~65_sumout\ & ( (\send_ppm1|local_counter1|o_count\(6) & (!\send_ppm1|local_counter1|o_count\(5) & (!\send_ppm1|local_counter1|o_count\(4) $ (\send_ppm1|Add12~61_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|Add12~69_sumout\ & ( !\send_ppm1|Add12~65_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(6) & (!\send_ppm1|local_counter1|o_count\(5) & (!\send_ppm1|local_counter1|o_count\(4) $ (\send_ppm1|Add12~61_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult0~16\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult0~21\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult2~15\,
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Mult2~16\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult2~17\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~41_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add4~9_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~1_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add4~33_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult1~15\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult1~16\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult1~17\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult1~18\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult1~19\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult1~20\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult1~21\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add2~37_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add2~17_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add2~33_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~41_sumout\ = SUM(( !\send_ppm1|Add5~49_sumout\ $ (!\send_ppm1|Add3~49_sumout\ $ (\send_ppm1|Add1~41_sumout\)) ) + ( \send_ppm1|Add8~71\ ) + ( \send_ppm1|Add8~70\ ))
-- \send_ppm1|Add8~42\ = CARRY(( !\send_ppm1|Add5~49_sumout\ $ (!\send_ppm1|Add3~49_sumout\ $ (\send_ppm1|Add1~41_sumout\)) ) + ( \send_ppm1|Add8~71\ ) + ( \send_ppm1|Add8~70\ ))
-- \send_ppm1|Add8~43\ = SHARE((!\send_ppm1|Add5~49_sumout\ & (\send_ppm1|Add3~49_sumout\ & \send_ppm1|Add1~41_sumout\)) # (\send_ppm1|Add5~49_sumout\ & ((\send_ppm1|Add1~41_sumout\) # (\send_ppm1|Add3~49_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~49_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~49_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~41_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~45_sumout\ = SUM(( !\send_ppm1|Add3~53_sumout\ $ (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|Add1~45_sumout\)) ) + ( \send_ppm1|Add8~43\ ) + ( \send_ppm1|Add8~42\ ))
-- \send_ppm1|Add8~46\ = CARRY(( !\send_ppm1|Add3~53_sumout\ $ (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|Add1~45_sumout\)) ) + ( \send_ppm1|Add8~43\ ) + ( \send_ppm1|Add8~42\ ))
-- \send_ppm1|Add8~47\ = SHARE((!\send_ppm1|Add3~53_sumout\ & (\send_ppm1|Add5~53_sumout\ & \send_ppm1|Add1~45_sumout\)) # (\send_ppm1|Add3~53_sumout\ & ((\send_ppm1|Add1~45_sumout\) # (\send_ppm1|Add5~53_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~53_sumout\,
	datac => \send_ppm1|ALT_INV_Add5~53_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~49_sumout\ = SUM(( !\send_ppm1|Add3~41_sumout\ $ (!\send_ppm1|Add1~49_sumout\ $ (\send_ppm1|Add5~41_sumout\)) ) + ( \send_ppm1|Add8~47\ ) + ( \send_ppm1|Add8~46\ ))
-- \send_ppm1|Add8~50\ = CARRY(( !\send_ppm1|Add3~41_sumout\ $ (!\send_ppm1|Add1~49_sumout\ $ (\send_ppm1|Add5~41_sumout\)) ) + ( \send_ppm1|Add8~47\ ) + ( \send_ppm1|Add8~46\ ))
-- \send_ppm1|Add8~51\ = SHARE((!\send_ppm1|Add3~41_sumout\ & (\send_ppm1|Add1~49_sumout\ & \send_ppm1|Add5~41_sumout\)) # (\send_ppm1|Add3~41_sumout\ & ((\send_ppm1|Add5~41_sumout\) # (\send_ppm1|Add1~49_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~41_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~49_sumout\,
	datad => \send_ppm1|ALT_INV_Add5~41_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~17_sumout\ = SUM(( !\send_ppm1|Add3~13_sumout\ $ (!\send_ppm1|Add1~13_sumout\ $ (\send_ppm1|Add5~13_sumout\)) ) + ( \send_ppm1|Add8~51\ ) + ( \send_ppm1|Add8~50\ ))
-- \send_ppm1|Add8~18\ = CARRY(( !\send_ppm1|Add3~13_sumout\ $ (!\send_ppm1|Add1~13_sumout\ $ (\send_ppm1|Add5~13_sumout\)) ) + ( \send_ppm1|Add8~51\ ) + ( \send_ppm1|Add8~50\ ))
-- \send_ppm1|Add8~19\ = SHARE((!\send_ppm1|Add3~13_sumout\ & (\send_ppm1|Add1~13_sumout\ & \send_ppm1|Add5~13_sumout\)) # (\send_ppm1|Add3~13_sumout\ & ((\send_ppm1|Add5~13_sumout\) # (\send_ppm1|Add1~13_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~13_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~13_sumout\,
	datad => \send_ppm1|ALT_INV_Add5~13_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~21_sumout\ = SUM(( !\send_ppm1|Add5~17_sumout\ $ (!\send_ppm1|Add3~17_sumout\ $ (\send_ppm1|Add1~17_sumout\)) ) + ( \send_ppm1|Add8~19\ ) + ( \send_ppm1|Add8~18\ ))
-- \send_ppm1|Add8~22\ = CARRY(( !\send_ppm1|Add5~17_sumout\ $ (!\send_ppm1|Add3~17_sumout\ $ (\send_ppm1|Add1~17_sumout\)) ) + ( \send_ppm1|Add8~19\ ) + ( \send_ppm1|Add8~18\ ))
-- \send_ppm1|Add8~23\ = SHARE((!\send_ppm1|Add5~17_sumout\ & (\send_ppm1|Add3~17_sumout\ & \send_ppm1|Add1~17_sumout\)) # (\send_ppm1|Add5~17_sumout\ & ((\send_ppm1|Add1~17_sumout\) # (\send_ppm1|Add3~17_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~17_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~17_sumout\,
	datad => \send_ppm1|ALT_INV_Add1~17_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~33_sumout\ = SUM(( !\send_ppm1|Add3~1_sumout\ $ (!\send_ppm1|Add5~1_sumout\ $ (\send_ppm1|Add1~5_sumout\)) ) + ( \send_ppm1|Add8~23\ ) + ( \send_ppm1|Add8~22\ ))
-- \send_ppm1|Add8~34\ = CARRY(( !\send_ppm1|Add3~1_sumout\ $ (!\send_ppm1|Add5~1_sumout\ $ (\send_ppm1|Add1~5_sumout\)) ) + ( \send_ppm1|Add8~23\ ) + ( \send_ppm1|Add8~22\ ))
-- \send_ppm1|Add8~35\ = SHARE((!\send_ppm1|Add3~1_sumout\ & (\send_ppm1|Add5~1_sumout\ & \send_ppm1|Add1~5_sumout\)) # (\send_ppm1|Add3~1_sumout\ & ((\send_ppm1|Add1~5_sumout\) # (\send_ppm1|Add5~1_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~1_sumout\,
	datac => \send_ppm1|ALT_INV_Add5~1_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~9_sumout\ = SUM(( !\send_ppm1|Add3~5_sumout\ $ (!\send_ppm1|Add1~9_sumout\ $ (\send_ppm1|Add5~5_sumout\)) ) + ( \send_ppm1|Add8~35\ ) + ( \send_ppm1|Add8~34\ ))
-- \send_ppm1|Add8~10\ = CARRY(( !\send_ppm1|Add3~5_sumout\ $ (!\send_ppm1|Add1~9_sumout\ $ (\send_ppm1|Add5~5_sumout\)) ) + ( \send_ppm1|Add8~35\ ) + ( \send_ppm1|Add8~34\ ))
-- \send_ppm1|Add8~11\ = SHARE((!\send_ppm1|Add3~5_sumout\ & (\send_ppm1|Add1~9_sumout\ & \send_ppm1|Add5~5_sumout\)) # (\send_ppm1|Add3~5_sumout\ & ((\send_ppm1|Add5~5_sumout\) # (\send_ppm1|Add1~9_sumout\))))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~5_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~9_sumout\,
	datad => \send_ppm1|ALT_INV_Add5~5_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~25_sumout\ = SUM(( !\send_ppm1|Add1~21_sumout\ $ (!\send_ppm1|Add5~21_sumout\ $ (\send_ppm1|Add3~21_sumout\)) ) + ( \send_ppm1|Add8~11\ ) + ( \send_ppm1|Add8~10\ ))
-- \send_ppm1|Add8~26\ = CARRY(( !\send_ppm1|Add1~21_sumout\ $ (!\send_ppm1|Add5~21_sumout\ $ (\send_ppm1|Add3~21_sumout\)) ) + ( \send_ppm1|Add8~11\ ) + ( \send_ppm1|Add8~10\ ))
-- \send_ppm1|Add8~27\ = SHARE((!\send_ppm1|Add1~21_sumout\ & (\send_ppm1|Add5~21_sumout\ & \send_ppm1|Add3~21_sumout\)) # (\send_ppm1|Add1~21_sumout\ & ((\send_ppm1|Add3~21_sumout\) # (\send_ppm1|Add5~21_sumout\))))
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Add5~21_sumout\,
	datad => \send_ppm1|ALT_INV_Add3~21_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add8~53_sumout\ = SUM(( !\send_ppm1|Add3~45_sumout\ $ (!\send_ppm1|Add1~57_sumout\ $ (\send_ppm1|Add5~45_sumout\)) ) + ( \send_ppm1|Add8~27\ ) + ( \send_ppm1|Add8~26\ ))
-- \send_ppm1|Add8~54\ = CARRY(( !\send_ppm1|Add3~45_sumout\ $ (!\send_ppm1|Add1~57_sumout\ $ (\send_ppm1|Add5~45_sumout\)) ) + ( \send_ppm1|Add8~27\ ) + ( \send_ppm1|Add8~26\ ))
-- \send_ppm1|Add8~55\ = SHARE((!\send_ppm1|Add3~45_sumout\ & (\send_ppm1|Add1~57_sumout\ & \send_ppm1|Add5~45_sumout\)) # (\send_ppm1|Add3~45_sumout\ & ((\send_ppm1|Add5~45_sumout\) # (\send_ppm1|Add1~57_sumout\))))
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~45_sumout\,
	datac => \send_ppm1|ALT_INV_Add1~57_sumout\,
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111111001100000000000000000000001100001100111100",
	shared_arith => "on")
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add1~1_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~15\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~19\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Mult3~20\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Mult3~21\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add6~29_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add6~33_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add6~37_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add6~5_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add6~25_sumout\,
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add6~53_sumout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add8~41_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~45_sumout\ = SUM(( \send_ppm1|Add7~45_sumout\ ) + ( \send_ppm1|Add8~45_sumout\ ) + ( \send_ppm1|Add10~42\ ))
-- \send_ppm1|Add10~46\ = CARRY(( \send_ppm1|Add7~45_sumout\ ) + ( \send_ppm1|Add8~45_sumout\ ) + ( \send_ppm1|Add10~42\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add8~45_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~45_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~49_sumout\ = SUM(( \send_ppm1|Add8~49_sumout\ ) + ( \send_ppm1|Add7~49_sumout\ ) + ( \send_ppm1|Add10~46\ ))
-- \send_ppm1|Add10~50\ = CARRY(( \send_ppm1|Add8~49_sumout\ ) + ( \send_ppm1|Add7~49_sumout\ ) + ( \send_ppm1|Add10~46\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add7~49_sumout\,
	datad => \send_ppm1|ALT_INV_Add8~49_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add7~9_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~21_sumout\ = SUM(( \send_ppm1|Add7~13_sumout\ ) + ( \send_ppm1|Add8~21_sumout\ ) + ( \send_ppm1|Add10~18\ ))
-- \send_ppm1|Add10~22\ = CARRY(( \send_ppm1|Add7~13_sumout\ ) + ( \send_ppm1|Add8~21_sumout\ ) + ( \send_ppm1|Add10~18\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add8~21_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~13_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~33_sumout\ = SUM(( \send_ppm1|Add7~33_sumout\ ) + ( \send_ppm1|Add8~33_sumout\ ) + ( \send_ppm1|Add10~22\ ))
-- \send_ppm1|Add10~34\ = CARRY(( \send_ppm1|Add7~33_sumout\ ) + ( \send_ppm1|Add8~33_sumout\ ) + ( \send_ppm1|Add10~22\ ))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add8~33_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~33_sumout\,
...
-- Equation(s):
-- \send_ppm1|Add10~53_sumout\ = SUM(( \send_ppm1|Add7~65_sumout\ ) + ( \send_ppm1|Add8~53_sumout\ ) + ( \send_ppm1|Add10~26\ ))
-- \send_ppm1|Add10~54\ = CARRY(( \send_ppm1|Add7~65_sumout\ ) + ( \send_ppm1|Add8~53_sumout\ ) + ( \send_ppm1|Add10~26\ ))
...
-- Equation(s):
-- \send_ppm1|Add10~57_sumout\ = SUM(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~57_sumout\ ) + ( \send_ppm1|Add10~54\ ))
-- \send_ppm1|Add10~58\ = CARRY(( !\send_ppm1|Add7~5_sumout\ ) + ( \send_ppm1|Add8~57_sumout\ ) + ( \send_ppm1|Add10~54\ ))
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add7~5_sumout\,
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add10~9_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~7_combout\ = ( \send_ppm1|Add12~53_sumout\ & ( (\send_ppm1|local_counter1|o_count\(15) & (\send_ppm1|Equal9~6_combout\ & (!\send_ppm1|local_counter1|o_count\(16) $ (\send_ppm1|Add12~57_sumout\)))) ) ) # ( !\send_ppm1|Add12~53_sumout\ & ( 
-- (!\send_ppm1|local_counter1|o_count\(15) & (\send_ppm1|Equal9~6_combout\ & (!\send_ppm1|local_counter1|o_count\(16) $ (\send_ppm1|Add12~57_sumout\)))) ) )
...
PORT MAP (
	...
	datac => \send_ppm1|ALT_INV_Equal9~6_combout\,
	datad => \send_ppm1|ALT_INV_Add12~57_sumout\,
	dataf => \send_ppm1|ALT_INV_Add12~53_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal0~2_combout\ = ( !\send_ppm1|local_counter1|o_count\(17) & ( \send_ppm1|local_counter1|o_count\(0) & ( (\send_ppm1|local_counter1|o_count\(3) & (\send_ppm1|local_counter1|o_count\(1) & (!\send_ppm1|local_counter1|o_count\(2) & 
-- !\send_ppm1|local_counter1|o_count\(5)))) ) ) )
...
-- Equation(s):
-- \send_ppm1|Equal0~0_combout\ = ( !\send_ppm1|local_counter1|o_count\(7) & ( \send_ppm1|local_counter1|o_count\(6) ) )
...
-- Equation(s):
-- \send_ppm1|Equal0~1_combout\ = ( !\send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|local_counter1|o_count\(10) & (\send_ppm1|local_counter1|o_count\(12) & (!\send_ppm1|local_counter1|o_count\(13) & 
-- \send_ppm1|local_counter1|o_count\(8)))) ) ) )
...
PORT MAP (
	...
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(9),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(11),
	combout => \send_ppm1|Equal0~1_combout\);

-- Location: LABCELL_X37_Y25_N3
\send_ppm1|sig_state~3\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|sig_state~3_combout\ = ( !\send_ppm1|sig_state\(0) & ( (\i_reset_n_top~input_o\ & \send_ppm1|current_state.tempo~q\) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_current_state.tempo~q\,
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|local_counter1|Add0~9_sumout\,
	sclr => \send_ppm1|local_counter1|o_count[17]~1_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|Add8~73_sumout\ = SUM(( !\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~59\ ) + ( \send_ppm1|Add8~58\ ))
-- \send_ppm1|Add8~74\ = CARRY(( !\send_ppm1|Add5~9_sumout\ $ (!\send_ppm1|Add1~1_sumout\ $ (!\send_ppm1|Add3~9_sumout\)) ) + ( \send_ppm1|Add8~59\ ) + ( \send_ppm1|Add8~58\ ))
-- \send_ppm1|Add8~75\ = SHARE((!\send_ppm1|Add5~9_sumout\ & ((!\send_ppm1|Add1~1_sumout\) # (!\send_ppm1|Add3~9_sumout\))) # (\send_ppm1|Add5~9_sumout\ & (!\send_ppm1|Add1~1_sumout\ & !\send_ppm1|Add3~9_sumout\)))

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000111010001110100000000000000000001001011010010110",
	shared_arith => "on")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~9_sumout\,
	datab => \send_ppm1|ALT_INV_Add1~1_sumout\,
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add8~73_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~8_combout\ = ( \send_ppm1|Add12~73_sumout\ & ( (\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|local_counter1|o_count\(18) $ (\send_ppm1|Add12~77_sumout\))) ) ) # ( !\send_ppm1|Add12~73_sumout\ & ( 
-- (!\send_ppm1|local_counter1|o_count\(17) & (!\send_ppm1|local_counter1|o_count\(18) $ (\send_ppm1|Add12~77_sumout\))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(18),
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(17),
	datac => \send_ppm1|ALT_INV_Add12~77_sumout\,
	dataf => \send_ppm1|ALT_INV_Add12~73_sumout\,
	combout => \send_ppm1|Equal9~8_combout\);

-- Location: LABCELL_X37_Y25_N36
\send_ppm1|sig_state~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|sig_state~0_combout\ = ( \i_reset_n_top~input_o\ & ( (\send_ppm1|current_state.tempo~q\ & (!\send_ppm1|sig_state\(2) $ (((!\send_ppm1|sig_state\(1)) # (!\send_ppm1|sig_state\(0)))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000000000000000000000000111100000000000011110",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_sig_state\(1),
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|sig_state~0_combout\,
	sload => VCC,
...
-- Equation(s):
-- \send_ppm1|Equal0~4_combout\ = ( \send_ppm1|Equal0~1_combout\ & ( \send_ppm1|Equal0~0_combout\ & ( (\send_ppm1|Equal0~2_combout\ & \send_ppm1|Equal0~3_combout\) ) ) )
...
PORT MAP (
	...
	dataf => \send_ppm1|ALT_INV_Equal0~0_combout\,
	combout => \send_ppm1|Equal0~4_combout\);

-- Location: LABCELL_X37_Y23_N0
\send_ppm1|sig_state[2]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|sig_state[2]~1_combout\ = ( !\send_ppm1|current_state.pulse~q\ & ( \send_ppm1|Equal0~4_combout\ & ( (!\send_ppm1|sig_state\(2)) # (((!\send_ppm1|current_state.tempo~q\) # (\send_ppm1|sig_state\(0))) # (\send_ppm1|sig_state\(1))) ) ) ) # ( 
-- !\send_ppm1|current_state.pulse~q\ & ( !\send_ppm1|Equal0~4_combout\ & ( !\send_ppm1|current_state.tempo~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1111000011110000000000000000000011111011111111110000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	...
	dataf => \send_ppm1|ALT_INV_Equal0~4_combout\,
	combout => \send_ppm1|sig_state[2]~1_combout\);

-- Location: LABCELL_X37_Y25_N54
\send_ppm1|sig_state[2]~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|sig_state[2]~2_combout\ = ( \send_ppm1|current_state.synchro~q\ & ( \send_ppm1|sig_state[2]~1_combout\ & ( (!\i_reset_n_top~input_o\) # ((\send_ppm1|Equal9~5_combout\ & (\send_ppm1|Equal9~8_combout\ & \send_ppm1|Equal9~7_combout\))) ) ) ) # ( 
-- !\send_ppm1|current_state.synchro~q\ & ( \send_ppm1|sig_state[2]~1_combout\ ) ) # ( \send_ppm1|current_state.synchro~q\ & ( !\send_ppm1|sig_state[2]~1_combout\ & ( !\i_reset_n_top~input_o\ ) ) ) # ( !\send_ppm1|current_state.synchro~q\ & ( 
-- !\send_ppm1|sig_state[2]~1_combout\ & ( !\i_reset_n_top~input_o\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110011001100110011001100110011111111111111111100110011001101",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal9~5_combout\,
	datab => \ALT_INV_i_reset_n_top~input_o\,
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|sig_state~3_combout\,
	sload => VCC,
	ena => \send_ppm1|sig_state[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|sig_state~4_combout\ = ( \i_reset_n_top~input_o\ & ( (\send_ppm1|current_state.tempo~q\ & (!\send_ppm1|sig_state\(1) $ (!\send_ppm1|sig_state\(0)))) ) )
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|sig_state~4_combout\,
	sload => VCC,
	ena => \send_ppm1|sig_state[2]~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|Equal1~0_combout\ = ( \send_ppm1|sig_state\(2) & ( (!\send_ppm1|sig_state\(1) & !\send_ppm1|sig_state\(0)) ) )
...
PORT MAP (
	...
	dataf => \send_ppm1|ALT_INV_sig_state\(2),
	combout => \send_ppm1|Equal1~0_combout\);

-- Location: MLABCELL_X39_Y23_N36
\send_ppm1|current_state~12\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|current_state~12_combout\ = ( \send_ppm1|Equal0~1_combout\ & ( \send_ppm1|Equal1~0_combout\ & ( (\send_ppm1|Equal0~2_combout\ & (\send_ppm1|Equal0~3_combout\ & (\send_ppm1|Equal0~0_combout\ & \send_ppm1|current_state.tempo~q\))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_Equal0~3_combout\,
	datac => \send_ppm1|ALT_INV_Equal0~0_combout\,
	datad => \send_ppm1|ALT_INV_current_state.tempo~q\,
	datae => \send_ppm1|ALT_INV_Equal0~1_combout\,
	dataf => \send_ppm1|ALT_INV_Equal1~0_combout\,
	combout => \send_ppm1|current_state~12_combout\);

-- Location: LABCELL_X37_Y25_N42
\send_ppm1|current_state~13\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|current_state~13_combout\ = ( \send_ppm1|current_state.synchro~q\ & ( \send_ppm1|Equal9~5_combout\ & ( (\i_reset_n_top~input_o\ & ((!\send_ppm1|Equal9~7_combout\) # ((!\send_ppm1|Equal9~8_combout\) # (\send_ppm1|current_state~12_combout\)))) ) 
...
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000110011000000001111111100000000001100110000000011111011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal9~7_combout\,
	datab => \send_ppm1|ALT_INV_current_state~12_combout\,
	datac => \send_ppm1|ALT_INV_Equal9~8_combout\,
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|current_state~13_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|current_state~9_combout\ = ( \send_ppm1|Equal9~8_combout\ & ( (\send_ppm1|Equal9~7_combout\ & (\i_reset_n_top~input_o\ & (\send_ppm1|Equal9~5_combout\ & \send_ppm1|current_state.synchro~q\))) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_current_state.synchro~q\,
	dataf => \send_ppm1|ALT_INV_Equal9~8_combout\,
...
-- Equation(s):
-- \send_ppm1|reg~2_combout\ = ( \send_ppm1|current_state.fin_trame~q\ & ( \send_ppm1|current_state.reset~q\ ) ) # ( \send_ppm1|current_state.fin_trame~q\ & ( !\send_ppm1|current_state.reset~q\ ) ) # ( !\send_ppm1|current_state.fin_trame~q\ & ( 
-- !\send_ppm1|current_state.reset~q\ ) )
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_current_state.fin_trame~q\,
	dataf => \send_ppm1|ALT_INV_current_state.reset~q\,
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_Add12~41_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~1_combout\ = ( \send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|Add12~9_sumout\ & ( (\send_ppm1|local_counter1|o_count\(10) & (\send_ppm1|Add12~17_sumout\ & (!\send_ppm1|Add12~13_sumout\ $ (\send_ppm1|local_counter1|o_count\(11))))) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|Add12~9_sumout\ & ( (\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|Add12~17_sumout\ & (!\send_ppm1|Add12~13_sumout\ $ (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|Add12~9_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(10) & (\send_ppm1|Add12~17_sumout\ & (!\send_ppm1|Add12~13_sumout\ $ (\send_ppm1|local_counter1|o_count\(11))))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|Add12~9_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(10) & (!\send_ppm1|Add12~17_sumout\ & (!\send_ppm1|Add12~13_sumout\ $ (\send_ppm1|local_counter1|o_count\(11))))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(10),
	datab => \send_ppm1|ALT_INV_Add12~13_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(11),
	datad => \send_ppm1|ALT_INV_Add12~17_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~0_combout\ = !\send_ppm1|local_counter1|o_count\(13) $ (!\send_ppm1|Add12~1_sumout\)
...
PORT MAP (
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(13),
	datad => \send_ppm1|ALT_INV_Add12~1_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~2_combout\ = ( \send_ppm1|Add12~33_sumout\ & ( \send_ppm1|Add12~37_sumout\ & ( (\send_ppm1|local_counter1|o_count\(1) & (\send_ppm1|local_counter1|o_count\(2) & (!\send_ppm1|local_counter1|o_count\(0) $ (\send_ppm1|Add12~29_sumout\)))) ) 
-- ) ) # ( !\send_ppm1|Add12~33_sumout\ & ( \send_ppm1|Add12~37_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(1) & (\send_ppm1|local_counter1|o_count\(2) & (!\send_ppm1|local_counter1|o_count\(0) $ (\send_ppm1|Add12~29_sumout\)))) ) ) ) # ( 
-- \send_ppm1|Add12~33_sumout\ & ( !\send_ppm1|Add12~37_sumout\ & ( (\send_ppm1|local_counter1|o_count\(1) & (!\send_ppm1|local_counter1|o_count\(2) & (!\send_ppm1|local_counter1|o_count\(0) $ (\send_ppm1|Add12~29_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|Add12~33_sumout\ & ( !\send_ppm1|Add12~37_sumout\ & ( (!\send_ppm1|local_counter1|o_count\(1) & (!\send_ppm1|local_counter1|o_count\(2) & (!\send_ppm1|local_counter1|o_count\(0) $ (\send_ppm1|Add12~29_sumout\)))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(1),
	datac => \send_ppm1|ALT_INV_Add12~29_sumout\,
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(2),
	datae => \send_ppm1|ALT_INV_Add12~33_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal9~3_combout\ = ( \send_ppm1|Add12~25_sumout\ & ( \send_ppm1|Equal9~2_combout\ & ( (\send_ppm1|local_counter1|o_count\(12) & (!\send_ppm1|local_counter1|o_count\(3) $ (\send_ppm1|Add12~21_sumout\))) ) ) ) # ( !\send_ppm1|Add12~25_sumout\ & 
-- ( \send_ppm1|Equal9~2_combout\ & ( (!\send_ppm1|local_counter1|o_count\(12) & (!\send_ppm1|local_counter1|o_count\(3) $ (\send_ppm1|Add12~21_sumout\))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(3),
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(12),
	datac => \send_ppm1|ALT_INV_Add12~21_sumout\,
	datae => \send_ppm1|ALT_INV_Add12~25_sumout\,
	dataf => \send_ppm1|ALT_INV_Equal9~2_combout\,
	combout => \send_ppm1|Equal9~3_combout\);

-- Location: LABCELL_X37_Y25_N48
\send_ppm1|Equal9~5\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|Equal9~5_combout\ = ( \send_ppm1|local_counter1|o_count\(19) & ( \send_ppm1|Equal9~3_combout\ & ( (\send_ppm1|Equal9~4_combout\ & (\send_ppm1|Equal9~1_combout\ & (!\send_ppm1|Equal9~0_combout\ & \send_ppm1|Add12~5_sumout\))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(19) & ( \send_ppm1|Equal9~3_combout\ & ( (\send_ppm1|Equal9~4_combout\ & (\send_ppm1|Equal9~1_combout\ & (!\send_ppm1|Equal9~0_combout\ & !\send_ppm1|Add12~5_sumout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Equal9~4_combout\,
	datab => \send_ppm1|ALT_INV_Equal9~1_combout\,
	datac => \send_ppm1|ALT_INV_Equal9~0_combout\,
	datad => \send_ppm1|ALT_INV_Add12~5_sumout\,
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(19),
	dataf => \send_ppm1|ALT_INV_Equal9~3_combout\,
	combout => \send_ppm1|Equal9~5_combout\);

-- Location: MLABCELL_X39_Y23_N33
\send_ppm1|current_state~7\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|current_state~7_combout\ = ( \send_ppm1|Equal0~1_combout\ & ( \send_ppm1|Equal0~0_combout\ & ( (\send_ppm1|current_state.tempo~q\ & ((!\send_ppm1|Equal0~2_combout\) # (!\send_ppm1|Equal0~3_combout\))) ) ) ) # ( !\send_ppm1|Equal0~1_combout\ & ( 
-- \send_ppm1|Equal0~0_combout\ & ( \send_ppm1|current_state.tempo~q\ ) ) ) # ( \send_ppm1|Equal0~1_combout\ & ( !\send_ppm1|Equal0~0_combout\ & ( \send_ppm1|current_state.tempo~q\ ) ) ) # ( !\send_ppm1|Equal0~1_combout\ & ( !\send_ppm1|Equal0~0_combout\ & ( 
-- \send_ppm1|current_state.tempo~q\ ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000011111111000000001111111100000000111111110000000011111100",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Equal0~2_combout\,
...
-- Equation(s):
-- \send_ppm1|next_state~15_combout\ = ( \send_ppm1|local_counter1|o_count\(10) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add3~17_sumout\ & (\send_ppm1|Add3~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(14) $ 
-- (\send_ppm1|Add3~21_sumout\)))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(10) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add3~17_sumout\ & (!\send_ppm1|Add3~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(14) $ 
-- (\send_ppm1|Add3~21_sumout\)))) ) ) ) # ( \send_ppm1|local_counter1|o_count\(10) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add3~17_sumout\ & (\send_ppm1|Add3~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(14) $ 
-- (\send_ppm1|Add3~21_sumout\)))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(10) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add3~17_sumout\ & (!\send_ppm1|Add3~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(14) $ 
-- (\send_ppm1|Add3~21_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(14),
	datab => \send_ppm1|ALT_INV_Add3~21_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~17_sumout\,
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add3~5_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~18_combout\ = ( \send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|local_counter1|o_count\(4) & ( (\send_ppm1|Add3~65_sumout\ & (\send_ppm1|Add3~57_sumout\ & (!\send_ppm1|Add3~61_sumout\ $ (\send_ppm1|local_counter1|o_count\(5))))) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|local_counter1|o_count\(4) & ( (!\send_ppm1|Add3~65_sumout\ & (\send_ppm1|Add3~57_sumout\ & (!\send_ppm1|Add3~61_sumout\ $ (\send_ppm1|local_counter1|o_count\(5))))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(6) & ( !\send_ppm1|local_counter1|o_count\(4) & ( (\send_ppm1|Add3~65_sumout\ & (!\send_ppm1|Add3~57_sumout\ & (!\send_ppm1|Add3~61_sumout\ $ (\send_ppm1|local_counter1|o_count\(5))))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(6) & ( !\send_ppm1|local_counter1|o_count\(4) & ( (!\send_ppm1|Add3~65_sumout\ & (!\send_ppm1|Add3~57_sumout\ & (!\send_ppm1|Add3~61_sumout\ $ (\send_ppm1|local_counter1|o_count\(5))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~65_sumout\,
	datab => \send_ppm1|ALT_INV_Add3~57_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~61_sumout\,
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(5),
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(6),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(4),
	combout => \send_ppm1|next_state~18_combout\);

-- Location: LABCELL_X35_Y24_N15
\send_ppm1|next_state~17\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~17_combout\ = ( \send_ppm1|local_counter1|o_count\(8) & ( \send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add3~53_sumout\ & \send_ppm1|Add3~49_sumout\) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(8) & ( 
-- \send_ppm1|local_counter1|o_count\(7) & ( (!\send_ppm1|Add3~53_sumout\ & \send_ppm1|Add3~49_sumout\) ) ) ) # ( \send_ppm1|local_counter1|o_count\(8) & ( !\send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add3~53_sumout\ & !\send_ppm1|Add3~49_sumout\) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(8) & ( !\send_ppm1|local_counter1|o_count\(7) & ( (!\send_ppm1|Add3~53_sumout\ & !\send_ppm1|Add3~49_sumout\) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~53_sumout\,
	datac => \send_ppm1|ALT_INV_Add3~49_sumout\,
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(8),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(7),
	combout => \send_ppm1|next_state~17_combout\);

-- Location: LABCELL_X35_Y24_N57
\send_ppm1|next_state~19\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~19_combout\ = ( \send_ppm1|next_state~18_combout\ & ( \send_ppm1|next_state~17_combout\ & ( (!\send_ppm1|Add3~45_sumout\ & (!\send_ppm1|local_counter1|o_count\(15) & (!\send_ppm1|local_counter1|o_count\(9) $ 
-- (\send_ppm1|Add3~41_sumout\)))) # (\send_ppm1|Add3~45_sumout\ & (\send_ppm1|local_counter1|o_count\(15) & (!\send_ppm1|local_counter1|o_count\(9) $ (\send_ppm1|Add3~41_sumout\)))) ) ) )
...
-- Equation(s):
-- \send_ppm1|Equal5~3_combout\ = !\send_ppm1|Add3~29_sumout\ $ (!\send_ppm1|local_counter1|o_count\(1))
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add3~29_sumout\,
...
-- Equation(s):
-- \send_ppm1|Equal5~5_combout\ = !\send_ppm1|Add3~37_sumout\ $ (!\send_ppm1|local_counter1|o_count\(3))
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add3~33_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~16_combout\ = ( !\send_ppm1|Equal5~5_combout\ & ( !\send_ppm1|Equal5~4_combout\ & ( (!\send_ppm1|sig_state\(0) & (\send_ppm1|sig_state\(1) & (!\send_ppm1|Equal5~3_combout\ & !\send_ppm1|Equal5~2_combout\))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_sig_state\(1),
	datac => \send_ppm1|ALT_INV_Equal5~3_combout\,
	datad => \send_ppm1|ALT_INV_Equal5~2_combout\,
	datae => \send_ppm1|ALT_INV_Equal5~5_combout\,
...
-- Equation(s):
-- \send_ppm1|Equal5~0_combout\ = ( !\send_ppm1|local_counter1|o_count\(12) & ( \send_ppm1|Add3~1_sumout\ ) ) # ( \send_ppm1|local_counter1|o_count\(12) & ( !\send_ppm1|Add3~1_sumout\ ) )
...
-- Equation(s):
-- \send_ppm1|next_state~14_combout\ = ( \send_ppm1|local_counter1|o_count\(18) & ( \send_ppm1|local_counter1|o_count\(19) & ( (!\send_ppm1|Add3~9_sumout\ & (\send_ppm1|local_counter1|o_count\(16) & \send_ppm1|local_counter1|o_count\(17))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(18) & ( !\send_ppm1|local_counter1|o_count\(19) & ( (\send_ppm1|Add3~9_sumout\ & (!\send_ppm1|local_counter1|o_count\(16) & !\send_ppm1|local_counter1|o_count\(17))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add3~9_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(16),
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(17),
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(18),
...
-- Equation(s):
-- \send_ppm1|next_state~20_combout\ = ( !\send_ppm1|Equal5~0_combout\ & ( \send_ppm1|next_state~14_combout\ & ( (\send_ppm1|next_state~15_combout\ & (!\send_ppm1|Equal5~1_combout\ & (\send_ppm1|next_state~19_combout\ & \send_ppm1|next_state~16_combout\))) ) 
-- ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_next_state~15_combout\,
	datab => \send_ppm1|ALT_INV_Equal5~1_combout\,
	datac => \send_ppm1|ALT_INV_next_state~19_combout\,
	datad => \send_ppm1|ALT_INV_next_state~16_combout\,
	datae => \send_ppm1|ALT_INV_Equal5~0_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~14_combout\,
	combout => \send_ppm1|next_state~20_combout\);

-- Location: LABCELL_X33_Y24_N42
\send_ppm1|next_state~8\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~8_combout\ = ( \send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add5~17_sumout\ & (\send_ppm1|Add5~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ 
-- (\send_ppm1|Add5~13_sumout\)))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add5~17_sumout\ & (!\send_ppm1|Add5~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ 
-- (\send_ppm1|Add5~13_sumout\)))) ) ) ) # ( \send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add5~17_sumout\ & (\send_ppm1|Add5~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ 
-- (\send_ppm1|Add5~13_sumout\)))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add5~17_sumout\ & (!\send_ppm1|Add5~21_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ 
-- (\send_ppm1|Add5~13_sumout\)))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~17_sumout\,
	datab => \send_ppm1|ALT_INV_Add5~21_sumout\,
...
-- Equation(s):
-- \send_ppm1|next_state~7_combout\ = ( \send_ppm1|local_counter1|o_count\(18) & ( \send_ppm1|local_counter1|o_count\(16) & ( (!\send_ppm1|Add5~9_sumout\ & (\send_ppm1|local_counter1|o_count\(17) & \send_ppm1|local_counter1|o_count\(19))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(18) & ( !\send_ppm1|local_counter1|o_count\(16) & ( (\send_ppm1|Add5~9_sumout\ & (!\send_ppm1|local_counter1|o_count\(17) & !\send_ppm1|local_counter1|o_count\(19))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add5~9_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(17),
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(19),
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(18),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(16),
	combout => \send_ppm1|next_state~7_combout\);

-- Location: MLABCELL_X34_Y23_N39
\send_ppm1|next_state~4\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~4_combout\ = ( \send_ppm1|local_counter1|o_count\(4) & ( \send_ppm1|local_counter1|o_count\(5) & ( (\send_ppm1|Add1~65_sumout\ & \send_ppm1|Add1~61_sumout\) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(4) & ( 
-- \send_ppm1|local_counter1|o_count\(5) & ( (\send_ppm1|Add1~65_sumout\ & !\send_ppm1|Add1~61_sumout\) ) ) ) # ( \send_ppm1|local_counter1|o_count\(4) & ( !\send_ppm1|local_counter1|o_count\(5) & ( (!\send_ppm1|Add1~65_sumout\ & \send_ppm1|Add1~61_sumout\) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(4) & ( !\send_ppm1|local_counter1|o_count\(5) & ( (!\send_ppm1|Add1~65_sumout\ & !\send_ppm1|Add1~61_sumout\) ) ) )
...
-- Equation(s):
-- \send_ppm1|next_state~5_combout\ = ( \send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|next_state~4_combout\ & ( (\send_ppm1|Add1~53_sumout\ & (!\send_ppm1|Add1~57_sumout\ $ (\send_ppm1|local_counter1|o_count\(15)))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(6) & ( \send_ppm1|next_state~4_combout\ & ( (!\send_ppm1|Add1~53_sumout\ & (!\send_ppm1|Add1~57_sumout\ $ (\send_ppm1|local_counter1|o_count\(15)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add1~53_sumout\,
	datab => \send_ppm1|ALT_INV_Add1~57_sumout\,
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(15),
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(6),
	dataf => \send_ppm1|ALT_INV_next_state~4_combout\,
	combout => \send_ppm1|next_state~5_combout\);

-- Location: LABCELL_X35_Y23_N6
\send_ppm1|Equal3~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|Equal3~1_combout\ = ( !\send_ppm1|Add1~9_sumout\ & ( \send_ppm1|local_counter1|o_count\(13) ) ) # ( \send_ppm1|Add1~9_sumout\ & ( !\send_ppm1|local_counter1|o_count\(13) ) )
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add1~9_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(13),
...
-- Equation(s):
-- \send_ppm1|next_state~1_combout\ = ( \send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add1~21_sumout\ & (\send_ppm1|Add1~17_sumout\ & (!\send_ppm1|Add1~13_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(10))))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add1~21_sumout\ & (\send_ppm1|Add1~17_sumout\ & (!\send_ppm1|Add1~13_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(10))))) ) ) ) # ( \send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add1~21_sumout\ & (!\send_ppm1|Add1~17_sumout\ & (!\send_ppm1|Add1~13_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(10))))) ) ) ) # ( !\send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add1~21_sumout\ & (!\send_ppm1|Add1~17_sumout\ & (!\send_ppm1|Add1~13_sumout\ $ 
-- (\send_ppm1|local_counter1|o_count\(10))))) ) ) )
...
-- Equation(s):
-- \send_ppm1|next_state~3_combout\ = ( \send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add1~41_sumout\ & (\send_ppm1|Add1~49_sumout\ & (!\send_ppm1|Add1~45_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add1~41_sumout\ & (!\send_ppm1|Add1~49_sumout\ & (!\send_ppm1|Add1~45_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(9) & ( !\send_ppm1|local_counter1|o_count\(7) & ( (!\send_ppm1|Add1~41_sumout\ & (\send_ppm1|Add1~49_sumout\ & (!\send_ppm1|Add1~45_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(9) & ( !\send_ppm1|local_counter1|o_count\(7) & ( (!\send_ppm1|Add1~41_sumout\ & (!\send_ppm1|Add1~49_sumout\ & (!\send_ppm1|Add1~45_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add1~5_sumout\,
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add1~25_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(0),
...
-- pragma translate_on
PORT MAP (
	datad => \send_ppm1|ALT_INV_Add1~33_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(2),
...
-- Equation(s):
-- \send_ppm1|next_state~2_combout\ = ( !\send_ppm1|Equal3~2_combout\ & ( !\send_ppm1|Equal3~4_combout\ & ( (!\send_ppm1|sig_state\(1) & (!\send_ppm1|Equal3~3_combout\ & (!\send_ppm1|Add1~37_sumout\ $ (\send_ppm1|local_counter1|o_count\(3))))) ) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Equal3~3_combout\,
	datae => \send_ppm1|ALT_INV_Equal3~2_combout\,
	dataf => \send_ppm1|ALT_INV_Equal3~4_combout\,
	combout => \send_ppm1|next_state~2_combout\);

-- Location: LABCELL_X35_Y23_N27
\send_ppm1|next_state~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~6_combout\ = ( !\send_ppm1|Equal3~0_combout\ & ( \send_ppm1|next_state~2_combout\ & ( (\send_ppm1|next_state~5_combout\ & (!\send_ppm1|Equal3~1_combout\ & (\send_ppm1|next_state~1_combout\ & \send_ppm1|next_state~3_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_next_state~5_combout\,
	datab => \send_ppm1|ALT_INV_Equal3~1_combout\,
	datac => \send_ppm1|ALT_INV_next_state~1_combout\,
	datad => \send_ppm1|ALT_INV_next_state~3_combout\,
	datae => \send_ppm1|ALT_INV_Equal3~0_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~2_combout\,
	combout => \send_ppm1|next_state~6_combout\);

-- Location: MLABCELL_X34_Y23_N27
\send_ppm1|next_state~11\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~11_combout\ = ( \send_ppm1|local_counter1|o_count\(4) & ( \send_ppm1|local_counter1|o_count\(5) & ( (\send_ppm1|Add5~57_sumout\ & (\send_ppm1|Add5~61_sumout\ & (!\send_ppm1|Add5~65_sumout\ $ (\send_ppm1|local_counter1|o_count\(6))))) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(4) & ( \send_ppm1|local_counter1|o_count\(5) & ( (!\send_ppm1|Add5~57_sumout\ & (\send_ppm1|Add5~61_sumout\ & (!\send_ppm1|Add5~65_sumout\ $ (\send_ppm1|local_counter1|o_count\(6))))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(4) & ( !\send_ppm1|local_counter1|o_count\(5) & ( (\send_ppm1|Add5~57_sumout\ & (!\send_ppm1|Add5~61_sumout\ & (!\send_ppm1|Add5~65_sumout\ $ (\send_ppm1|local_counter1|o_count\(6))))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(4) & ( !\send_ppm1|local_counter1|o_count\(5) & ( (!\send_ppm1|Add5~57_sumout\ & (!\send_ppm1|Add5~61_sumout\ & (!\send_ppm1|Add5~65_sumout\ $ (\send_ppm1|local_counter1|o_count\(6))))) ) ) )
...
-- Equation(s):
-- \send_ppm1|Equal7~0_combout\ = ( \send_ppm1|local_counter1|o_count\(12) & ( !\send_ppm1|Add5~1_sumout\ ) ) # ( !\send_ppm1|local_counter1|o_count\(12) & ( \send_ppm1|Add5~1_sumout\ ) )
...
-- Equation(s):
-- \send_ppm1|Equal7~2_combout\ = ( \send_ppm1|local_counter1|o_count\(0) & ( !\send_ppm1|Add5~25_sumout\ ) ) # ( !\send_ppm1|local_counter1|o_count\(0) & ( \send_ppm1|Add5~25_sumout\ ) )
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add5~33_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(2),
...
-- Equation(s):
-- \send_ppm1|next_state~9_combout\ = ( !\send_ppm1|Equal7~3_combout\ & ( !\send_ppm1|Equal7~4_combout\ & ( (\send_ppm1|sig_state\(1) & (!\send_ppm1|Equal7~2_combout\ & (!\send_ppm1|local_counter1|o_count\(3) $ (\send_ppm1|Add5~37_sumout\)))) ) ) )
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_Equal7~3_combout\,
	dataf => \send_ppm1|ALT_INV_Equal7~4_combout\,
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add5~45_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(15),
	combout => \send_ppm1|Equal7~5_combout\);

-- Location: LABCELL_X37_Y23_N27
\send_ppm1|next_state~22\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~22_combout\ = ( \send_ppm1|local_counter1|o_count\(7) & ( \send_ppm1|local_counter1|o_count\(9) & ( (\send_ppm1|Add5~49_sumout\ & (\send_ppm1|Add5~41_sumout\ & (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) 
-- ) ) ) # ( !\send_ppm1|local_counter1|o_count\(7) & ( \send_ppm1|local_counter1|o_count\(9) & ( (!\send_ppm1|Add5~49_sumout\ & (\send_ppm1|Add5~41_sumout\ & (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(7) & ( !\send_ppm1|local_counter1|o_count\(9) & ( (\send_ppm1|Add5~49_sumout\ & (!\send_ppm1|Add5~41_sumout\ & (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(7) & ( !\send_ppm1|local_counter1|o_count\(9) & ( (!\send_ppm1|Add5~49_sumout\ & (!\send_ppm1|Add5~41_sumout\ & (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|local_counter1|o_count\(8))))) ) ) )
...
PORT MAP (
	...
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(8),
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(7),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(9),
	combout => \send_ppm1|next_state~22_combout\);

-- Location: LABCELL_X36_Y23_N15
\send_ppm1|Equal7~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|Equal7~1_combout\ = ( \send_ppm1|local_counter1|o_count\(13) & ( !\send_ppm1|Add5~5_sumout\ ) ) # ( !\send_ppm1|local_counter1|o_count\(13) & ( \send_ppm1|Add5~5_sumout\ ) )
...
-- Equation(s):
-- \send_ppm1|next_state~23_combout\ = ( \send_ppm1|next_state~22_combout\ & ( !\send_ppm1|Equal7~1_combout\ & ( (\send_ppm1|next_state~11_combout\ & (!\send_ppm1|Equal7~0_combout\ & (\send_ppm1|next_state~9_combout\ & !\send_ppm1|Equal7~5_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_next_state~11_combout\,
	datab => \send_ppm1|ALT_INV_Equal7~0_combout\,
	datac => \send_ppm1|ALT_INV_next_state~9_combout\,
	datad => \send_ppm1|ALT_INV_Equal7~5_combout\,
	datae => \send_ppm1|ALT_INV_next_state~22_combout\,
	dataf => \send_ppm1|ALT_INV_Equal7~1_combout\,
	combout => \send_ppm1|next_state~23_combout\);

-- Location: LABCELL_X33_Y24_N30
\send_ppm1|next_state~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~0_combout\ = ( \send_ppm1|local_counter1|o_count\(18) & ( \send_ppm1|local_counter1|o_count\(16) & ( (!\send_ppm1|Add1~1_sumout\ & (\send_ppm1|local_counter1|o_count\(19) & \send_ppm1|local_counter1|o_count\(17))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(18) & ( !\send_ppm1|local_counter1|o_count\(16) & ( (\send_ppm1|Add1~1_sumout\ & (!\send_ppm1|local_counter1|o_count\(19) & !\send_ppm1|local_counter1|o_count\(17))) ) ) )
...
-- Equation(s):
-- \send_ppm1|next_state~24_combout\ = ( \send_ppm1|next_state~23_combout\ & ( \send_ppm1|next_state~0_combout\ & ( (\send_ppm1|sig_state\(0) & (((\send_ppm1|next_state~8_combout\ & \send_ppm1|next_state~7_combout\)) # (\send_ppm1|next_state~6_combout\))) ) 
-- ) ) # ( !\send_ppm1|next_state~23_combout\ & ( \send_ppm1|next_state~0_combout\ & ( (\send_ppm1|sig_state\(0) & \send_ppm1|next_state~6_combout\) ) ) ) # ( \send_ppm1|next_state~23_combout\ & ( !\send_ppm1|next_state~0_combout\ & ( 
-- (\send_ppm1|next_state~8_combout\ & (\send_ppm1|sig_state\(0) & \send_ppm1|next_state~7_combout\)) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000000010000000100000000001100110000000100110011",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_next_state~8_combout\,
	datab => \send_ppm1|ALT_INV_sig_state\(0),
	datac => \send_ppm1|ALT_INV_next_state~7_combout\,
	datad => \send_ppm1|ALT_INV_next_state~6_combout\,
	datae => \send_ppm1|ALT_INV_next_state~23_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~0_combout\,
...
-- pragma translate_on
PORT MAP (
	datae => \send_ppm1|ALT_INV_Add7~53_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(4),
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add7~57_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(5),
...
-- Equation(s):
-- \send_ppm1|combi~5_combout\ = ( !\send_ppm1|Equal8~4_combout\ & ( !\send_ppm1|Equal8~5_combout\ & ( (!\send_ppm1|Add7~65_sumout\ & (!\send_ppm1|local_counter1|o_count\(15) & (!\send_ppm1|Add7~61_sumout\ $ (\send_ppm1|local_counter1|o_count\(6))))) # 
-- (\send_ppm1|Add7~65_sumout\ & (\send_ppm1|local_counter1|o_count\(15) & (!\send_ppm1|Add7~61_sumout\ $ (\send_ppm1|local_counter1|o_count\(6))))) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_Add7~61_sumout\,
...
-- Equation(s):
-- \send_ppm1|combi~1_combout\ = ( \send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add7~17_sumout\ & (\send_ppm1|Add7~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add7~9_sumout\)))) ) ) 
-- ) # ( !\send_ppm1|local_counter1|o_count\(14) & ( \send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add7~17_sumout\ & (\send_ppm1|Add7~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add7~9_sumout\)))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (\send_ppm1|Add7~17_sumout\ & (!\send_ppm1|Add7~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add7~9_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(14) & ( !\send_ppm1|local_counter1|o_count\(11) & ( (!\send_ppm1|Add7~17_sumout\ & (!\send_ppm1|Add7~13_sumout\ & (!\send_ppm1|local_counter1|o_count\(10) $ (\send_ppm1|Add7~9_sumout\)))) ) ) )
...
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(10),
	datab => \send_ppm1|ALT_INV_Add7~17_sumout\,
	datac => \send_ppm1|ALT_INV_Add7~9_sumout\,
	datad => \send_ppm1|ALT_INV_Add7~13_sumout\,
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(14),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(11),
...
-- Equation(s):
-- \send_ppm1|combi~4_combout\ = ( \send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add7~41_sumout\ & (\send_ppm1|Add7~49_sumout\ & (!\send_ppm1|local_counter1|o_count\(8) $ (\send_ppm1|Add7~45_sumout\)))) ) ) ) 
-- # ( !\send_ppm1|local_counter1|o_count\(9) & ( \send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add7~41_sumout\ & (!\send_ppm1|Add7~49_sumout\ & (!\send_ppm1|local_counter1|o_count\(8) $ (\send_ppm1|Add7~45_sumout\)))) ) ) ) # ( 
-- \send_ppm1|local_counter1|o_count\(9) & ( !\send_ppm1|local_counter1|o_count\(7) & ( (!\send_ppm1|Add7~41_sumout\ & (\send_ppm1|Add7~49_sumout\ & (!\send_ppm1|local_counter1|o_count\(8) $ (\send_ppm1|Add7~45_sumout\)))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(9) & ( !\send_ppm1|local_counter1|o_count\(7) & ( (!\send_ppm1|Add7~41_sumout\ & (!\send_ppm1|Add7~49_sumout\ & (!\send_ppm1|local_counter1|o_count\(8) $ (\send_ppm1|Add7~45_sumout\)))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add7~41_sumout\,
	datab => \send_ppm1|ALT_INV_Add7~49_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(8),
	datad => \send_ppm1|ALT_INV_Add7~45_sumout\,
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(9),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(7),
...
-- Equation(s):
-- \send_ppm1|Equal8~0_combout\ = ( \send_ppm1|local_counter1|o_count\(13) & ( !\send_ppm1|Add7~1_sumout\ ) ) # ( !\send_ppm1|local_counter1|o_count\(13) & ( \send_ppm1|Add7~1_sumout\ ) )
...
-- pragma translate_on
PORT MAP (
	datac => \send_ppm1|ALT_INV_Add7~1_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(13),
...
-- Equation(s):
-- \send_ppm1|combi~0_combout\ = ( \send_ppm1|local_counter1|o_count\(18) & ( \send_ppm1|local_counter1|o_count\(19) & ( (!\send_ppm1|Add7~5_sumout\ & (\send_ppm1|local_counter1|o_count\(17) & \send_ppm1|local_counter1|o_count\(16))) ) ) ) # ( 
-- !\send_ppm1|local_counter1|o_count\(18) & ( !\send_ppm1|local_counter1|o_count\(19) & ( (\send_ppm1|Add7~5_sumout\ & (!\send_ppm1|local_counter1|o_count\(17) & !\send_ppm1|local_counter1|o_count\(16))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add7~5_sumout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(17),
...
-- pragma translate_on
PORT MAP (
	datab => \send_ppm1|ALT_INV_Add7~25_sumout\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(2),
...
-- Equation(s):
-- \send_ppm1|Equal8~3_combout\ = ( \send_ppm1|local_counter1|o_count\(3) & ( !\send_ppm1|Add7~29_sumout\ ) ) # ( !\send_ppm1|local_counter1|o_count\(3) & ( \send_ppm1|Add7~29_sumout\ ) )
...
PORT MAP (
	...
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(3),
	combout => \send_ppm1|Equal8~3_combout\);

-- Location: LABCELL_X37_Y23_N15
\send_ppm1|combi~2\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|combi~2_combout\ = ( !\send_ppm1|sig_state\(0) & ( (!\send_ppm1|sig_state\(1) & (\send_ppm1|sig_state\(2) & (!\send_ppm1|Add7~37_sumout\ $ (\send_ppm1|local_counter1|o_count\(0))))) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add7~37_sumout\,
	datab => \send_ppm1|local_counter1|ALT_INV_o_count\(0),
...
-- Equation(s):
-- \send_ppm1|combi~3_combout\ = ( !\send_ppm1|Equal8~3_combout\ & ( \send_ppm1|combi~2_combout\ & ( (!\send_ppm1|Equal8~1_combout\ & (!\send_ppm1|Equal8~2_combout\ & (!\send_ppm1|Add7~33_sumout\ $ (\send_ppm1|local_counter1|o_count\(12))))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_Add7~33_sumout\,
	datab => \send_ppm1|ALT_INV_Equal8~1_combout\,
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(12),
	datad => \send_ppm1|ALT_INV_Equal8~2_combout\,
	datae => \send_ppm1|ALT_INV_Equal8~3_combout\,
	dataf => \send_ppm1|ALT_INV_combi~2_combout\,
	combout => \send_ppm1|combi~3_combout\);

-- Location: LABCELL_X36_Y23_N30
\send_ppm1|combi~6\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|combi~6_combout\ = ( \send_ppm1|combi~0_combout\ & ( \send_ppm1|combi~3_combout\ & ( (\send_ppm1|combi~5_combout\ & (\send_ppm1|combi~1_combout\ & (\send_ppm1|combi~4_combout\ & !\send_ppm1|Equal8~0_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_combi~5_combout\,
	datab => \send_ppm1|ALT_INV_combi~1_combout\,
	datac => \send_ppm1|ALT_INV_combi~4_combout\,
	datad => \send_ppm1|ALT_INV_Equal8~0_combout\,
	datae => \send_ppm1|ALT_INV_combi~0_combout\,
	dataf => \send_ppm1|ALT_INV_combi~3_combout\,
	combout => \send_ppm1|combi~6_combout\);

-- Location: LABCELL_X36_Y23_N18
\send_ppm1|local_counter1|o_count[17]~0\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|local_counter1|o_count[17]~0_combout\ = ( \send_ppm1|next_state~24_combout\ & ( \send_ppm1|combi~6_combout\ & ( !\send_ppm1|current_state~7_combout\ ) ) ) # ( !\send_ppm1|next_state~24_combout\ & ( \send_ppm1|combi~6_combout\ & ( 
-- !\send_ppm1|current_state~7_combout\ ) ) ) # ( \send_ppm1|next_state~24_combout\ & ( !\send_ppm1|combi~6_combout\ & ( (!\send_ppm1|current_state~7_combout\ & ((!\send_ppm1|current_state.pulse~q\) # (!\send_ppm1|sig_state\(2)))) ) ) ) # ( 
-- !\send_ppm1|next_state~24_combout\ & ( !\send_ppm1|combi~6_combout\ & ( (!\send_ppm1|current_state~7_combout\ & ((!\send_ppm1|current_state.pulse~q\) # ((\send_ppm1|next_state~20_combout\ & !\send_ppm1|sig_state\(2))))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1000101010001000101010101000100010101010101010101010101010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_current_state~7_combout\,
	datab => \send_ppm1|ALT_INV_current_state.pulse~q\,
	datac => \send_ppm1|ALT_INV_next_state~20_combout\,
	datad => \send_ppm1|ALT_INV_sig_state\(2),
	datae => \send_ppm1|ALT_INV_next_state~24_combout\,
	dataf => \send_ppm1|ALT_INV_combi~6_combout\,
	combout => \send_ppm1|local_counter1|o_count[17]~0_combout\);

-- Location: LABCELL_X37_Y25_N57
\send_ppm1|local_counter1|o_count[17]~1\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|local_counter1|o_count[17]~1_combout\ = ( \send_ppm1|current_state.synchro~q\ & ( \send_ppm1|local_counter1|o_count[17]~0_combout\ & ( (!\i_reset_n_top~input_o\) # ((\send_ppm1|Equal9~5_combout\ & (\send_ppm1|Equal9~7_combout\ & 
-- \send_ppm1|Equal9~8_combout\))) ) ) ) # ( !\send_ppm1|current_state.synchro~q\ & ( \send_ppm1|local_counter1|o_count[17]~0_combout\ ) ) # ( \send_ppm1|current_state.synchro~q\ & ( !\send_ppm1|local_counter1|o_count[17]~0_combout\ & ( 
-- !\i_reset_n_top~input_o\ ) ) ) # ( !\send_ppm1|current_state.synchro~q\ & ( !\send_ppm1|local_counter1|o_count[17]~0_combout\ & ( !\i_reset_n_top~input_o\ ) ) )
...
PORT MAP (
	...
	datae => \send_ppm1|ALT_INV_current_state.synchro~q\,
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count[17]~0_combout\,
	combout => \send_ppm1|local_counter1|o_count[17]~1_combout\);
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|local_counter1|ALT_INV_o_count\(1),
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|local_counter1|Add0~45_sumout\,
	sclr => \send_ppm1|local_counter1|o_count[17]~1_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|local_counter1|Add0~57_sumout\,
	sclr => \send_ppm1|local_counter1|o_count[17]~1_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|Equal0~3_combout\ = ( !\send_ppm1|local_counter1|o_count\(16) & ( !\send_ppm1|local_counter1|o_count\(14) & ( (!\send_ppm1|local_counter1|o_count\(15) & (!\send_ppm1|local_counter1|o_count\(19) & (!\send_ppm1|local_counter1|o_count\(18) & 
-- !\send_ppm1|local_counter1|o_count\(4)))) ) ) )
...
PORT MAP (
	...
	datac => \send_ppm1|local_counter1|ALT_INV_o_count\(18),
	datad => \send_ppm1|local_counter1|ALT_INV_o_count\(4),
	datae => \send_ppm1|local_counter1|ALT_INV_o_count\(16),
	dataf => \send_ppm1|local_counter1|ALT_INV_o_count\(14),
	combout => \send_ppm1|Equal0~3_combout\);

-- Location: MLABCELL_X39_Y23_N0
\send_ppm1|current_state~10\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|current_state~10_combout\ = ( \send_ppm1|Equal0~2_combout\ & ( \send_ppm1|Equal0~1_combout\ & ( (\send_ppm1|current_state.tempo~q\ & (\send_ppm1|Equal0~3_combout\ & \send_ppm1|Equal0~0_combout\)) ) ) )
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_Equal0~3_combout\,
	datac => \send_ppm1|ALT_INV_Equal0~0_combout\,
	datae => \send_ppm1|ALT_INV_Equal0~2_combout\,
	dataf => \send_ppm1|ALT_INV_Equal0~1_combout\,
	combout => \send_ppm1|current_state~10_combout\);

-- Location: LABCELL_X37_Y23_N36
\send_ppm1|next_state~10\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~10_combout\ = ( \send_ppm1|local_counter1|o_count\(7) & ( (\send_ppm1|Add5~49_sumout\ & (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|local_counter1|o_count\(8)))) ) ) # ( !\send_ppm1|local_counter1|o_count\(7) & ( 
-- (!\send_ppm1|Add5~49_sumout\ & (!\send_ppm1|Add5~53_sumout\ $ (\send_ppm1|local_counter1|o_count\(8)))) ) )
...
-- Equation(s):
-- \send_ppm1|next_state~12_combout\ = ( \send_ppm1|next_state~10_combout\ & ( \send_ppm1|next_state~11_combout\ & ( (!\send_ppm1|local_counter1|o_count\(9) & (!\send_ppm1|Add5~41_sumout\ & (!\send_ppm1|local_counter1|o_count\(15) $ 
...
PORT MAP (
	...
	datad => \send_ppm1|ALT_INV_Add5~41_sumout\,
	datae => \send_ppm1|ALT_INV_next_state~10_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~11_combout\,
	combout => \send_ppm1|next_state~12_combout\);

-- Location: LABCELL_X36_Y23_N6
\send_ppm1|next_state~13\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~13_combout\ = ( \send_ppm1|next_state~8_combout\ & ( !\send_ppm1|Equal7~0_combout\ & ( (\send_ppm1|next_state~9_combout\ & (!\send_ppm1|Equal7~1_combout\ & (\send_ppm1|next_state~12_combout\ & \send_ppm1|next_state~7_combout\))) ) ) 
-- )
...
PORT MAP (
	...
	datab => \send_ppm1|ALT_INV_Equal7~1_combout\,
	datac => \send_ppm1|ALT_INV_next_state~12_combout\,
	datad => \send_ppm1|ALT_INV_next_state~7_combout\,
	datae => \send_ppm1|ALT_INV_next_state~8_combout\,
	dataf => \send_ppm1|ALT_INV_Equal7~0_combout\,
	combout => \send_ppm1|next_state~13_combout\);

-- Location: LABCELL_X36_Y23_N24
\send_ppm1|next_state~21\ : cyclonev_lcell_comb
-- Equation(s):
-- \send_ppm1|next_state~21_combout\ = ( \send_ppm1|next_state~20_combout\ & ( \send_ppm1|next_state~13_combout\ & ( !\send_ppm1|sig_state\(2) ) ) ) # ( !\send_ppm1|next_state~20_combout\ & ( \send_ppm1|next_state~13_combout\ & ( (!\send_ppm1|sig_state\(2) & 
-- \send_ppm1|sig_state\(0)) ) ) ) # ( \send_ppm1|next_state~20_combout\ & ( !\send_ppm1|next_state~13_combout\ & ( !\send_ppm1|sig_state\(2) ) ) ) # ( !\send_ppm1|next_state~20_combout\ & ( !\send_ppm1|next_state~13_combout\ & ( (!\send_ppm1|sig_state\(2) & 
-- (\send_ppm1|sig_state\(0) & (\send_ppm1|next_state~6_combout\ & \send_ppm1|next_state~0_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000010101010101010101000100010001000101010101010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_sig_state\(2),
	datab => \send_ppm1|ALT_INV_sig_state\(0),
	datac => \send_ppm1|ALT_INV_next_state~6_combout\,
	datad => \send_ppm1|ALT_INV_next_state~0_combout\,
	datae => \send_ppm1|ALT_INV_next_state~20_combout\,
...
-- Equation(s):
-- \send_ppm1|current_state~11_combout\ = ( !\send_ppm1|Equal1~0_combout\ & ( \send_ppm1|next_state~21_combout\ & ( (\i_reset_n_top~input_o\ & \send_ppm1|current_state~10_combout\) ) ) ) # ( \send_ppm1|Equal1~0_combout\ & ( !\send_ppm1|next_state~21_combout\ 
-- & ( (\i_reset_n_top~input_o\ & (\send_ppm1|current_state.pulse~q\ & !\send_ppm1|combi~6_combout\)) ) ) ) # ( !\send_ppm1|Equal1~0_combout\ & ( !\send_ppm1|next_state~21_combout\ & ( (\i_reset_n_top~input_o\ & (((\send_ppm1|current_state.pulse~q\ & 
-- !\send_ppm1|combi~6_combout\)) # (\send_ppm1|current_state~10_combout\))) ) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0001010100000101000100010000000000000101000001010000000000000000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_i_reset_n_top~input_o\,
	datab => \send_ppm1|ALT_INV_current_state.pulse~q\,
	datac => \send_ppm1|ALT_INV_current_state~10_combout\,
	datad => \send_ppm1|ALT_INV_combi~6_combout\,
	datae => \send_ppm1|ALT_INV_Equal1~0_combout\,
	dataf => \send_ppm1|ALT_INV_next_state~21_combout\,
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|current_state~11_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
...
-- Equation(s):
-- \send_ppm1|current_state~8_combout\ = ( \send_ppm1|reg~2_combout\ & ( \send_ppm1|next_state~21_combout\ & ( \i_reset_n_top~input_o\ ) ) ) # ( !\send_ppm1|reg~2_combout\ & ( \send_ppm1|next_state~21_combout\ & ( (\i_reset_n_top~input_o\ & 
-- ((\send_ppm1|current_state~7_combout\) # (\send_ppm1|current_state.pulse~q\))) ) ) ) # ( \send_ppm1|reg~2_combout\ & ( !\send_ppm1|next_state~21_combout\ & ( \i_reset_n_top~input_o\ ) ) ) # ( !\send_ppm1|reg~2_combout\ & ( 
-- !\send_ppm1|next_state~21_combout\ & ( (\i_reset_n_top~input_o\ & (((\send_ppm1|current_state.pulse~q\ & \send_ppm1|combi~6_combout\)) # (\send_ppm1|current_state~7_combout\))) ) ) )
...
-- pragma translate_on
PORT MAP (
	dataa => \send_ppm1|ALT_INV_current_state.pulse~q\,
...
PORT MAP (
	clk => \sig_clk25~q\,
	asdata => \send_ppm1|sig_out_ppm~0_combout\,
	sload => VCC,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
