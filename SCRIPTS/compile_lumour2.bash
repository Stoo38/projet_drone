...
BENCH_VERILOG_FILES="
					tbench_sans_top.sv"										#List of the different Verilog Files used for the bench
...
vsim -L LIB_VHD -do runSimLu2.do -novopt LIB_VHD_BENCH.tbench 	#Interface graphique sans warnings
